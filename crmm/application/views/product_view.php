            ...
            <section class="section_card" id="table_section">
                ...
                <div class="panel-body " style="padding-top:0px;">
                  ...
                  <tbody>
                    ...
                    <td>
                    <a 
                     href="<?php echo base_url(); ?>/products/edit_product/<?php echo $products->id; ?>"> <button type="button" class="btn-transparent btn-red"  style=" width:100%;"><i class="fa fa-pencil"></i>
                   </a>
                      </td>
