				...
				<section role="main" class="content-body" >
					...
					<section class="section_card">
						 ...
						 <div class="panel-body" style="padding-left:0px; padding-right:0px;  background-color:#27293d; padding-top:15px; padding-bottom:0px;">
										<form class="form-horizontal form-bordered" action="<?php echo base_url(); ?>master/add_source" method="post">
                    <div class="col-md-6" style="padding:0px;">
									...
									<div class="col-md-12">
											<div class="form-group">
												...
												<div class="col-md-12">
													<a href="<?php echo base_url(); ?>master/source_details">	<button type="button" class="btn-transparent btn-red"  style=" width:80px;">Cancel</button></a>
