				...
				<section role="main" class="content-body">
					...
					<section class="panel">
							<header class="panel-heading">
								...
								<h2 class="panel-title">Recharge Details </h2>
							...
							<div class="panel-body">
                               ...
                               <div class="col-md-3">
 								<div class="form-group">
									 <select class="form-control" name="recharge_amount">
									 	 <option value="">Recharge Amount</option>
									 	<?php foreach($recharge_list as $row){ ?>
                                           <option value="<?php echo $row->recharge_amount; ?>"  <?php if(isset($return_recharge)){ if($return_recharge == $row->recharge_amount){ echo 'selected'; }}?> ><?php echo $row->recharge_amount; ?></option>
								...
								<table class="table table-bordered table-striped mb-none" id="datatable-details">
									<h2 class="panel-title">Recharge List </h2>
									<thead>
										<tr>
									    	
										   <th class=" btn-info">Recharge Id</th>
					                       <th class=" btn-info">Customer Name</th>
					                       <th class=" btn-info">Recharge Amount</th>
