<!-- Vendor -->
		...
		<script src="<?php echo base_url();?>/<?php echo base_url();?>/assets/vendor/flot/jquery.flot.pie.js"></script>
		...
		<script src="<?php echo base_url();?>/assets/javascripts/image-compressor.js"></script>