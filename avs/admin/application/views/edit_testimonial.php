									...
									<div class="panel-body">
										<form class="form-horizontal form-bordered" method="post" action="">
											...
											<div id="img_label" style="width:150px; height:150px;">
                                                  ...
                                                  <img src="<?php echo base_url(); ?>/upload/testimonial/<?php echo $selected_list[0]->testimonial_image; ?>" alt="" style="width:100%; height:100%;">

                                                   <input type="hidden" value="<?php echo $selected_list[0]->testimonial_image; ?>" name="image_name">
											</div>
										   </label>
