									...
									<div class="panel-body">
										<form class="form-horizontal form-bordered" method="post" action="">
                                             ...
                                             <div class="form-group" style="display: none;">
												...
												<div class="col-md-6">
													<input type="file" name="file" class="form-control" id="file"  data-img_folder_name="blog">
												</div>
											</div>
											<label  for="file">
											<div id="img_label" style="width:150px; height:150px;">

                                                   <img src="<?php echo base_url(); ?>/upload/blog/<?php echo $selected_list[0]->blog_image; ?>" alt="" style="width:100%; height:100%;">

                                                   <input type="hidden" value="<?php echo $selected_list[0]->blog_image; ?>" name="image_name">
											</div>
										   </label>
											...
											<div class="form-group">
												...
												<div class="col-md-6">
													<input type="date" name="my_date" class="form-control" value="<?php echo $selected_list[0]->date; ?>" required >
												</div>
											</div>  
											<div class="form-group" >
    ...
    document.getElementById('file').addEventListener('change', (e) => {
        ...
        success(result) {
           ...
           formData.append('img_folder_name', img_folder_name);
            $.ajax({
		    	url: '<?php echo base_url(); ?>/portfolio/upload_image',
		    	method:"POST",
		    	data:formData,
		    	contentType:false,
		    	cache:false,
