...
<body>
     ...
     <!--head_bar section -->
     <!--head_bar section -->
  <?php $this->load->view('menu_bar.php'); ?>
     <!--menu_bar section -->
     <!--menu_bar section -->
     <!--menu_bar section -->
     <!--menu_bar section -->
        ...
        <table class="table">
           ...
           <tbody>
               ...
               <?php foreach($cart_data as $row){ ?>
                <tr>
                    <td>
                        <b><?php echo $row->product_current_no; ?></b>
                     ...
                     <td>
                         <b>Rs. <?php echo $row->product_rate; ?></b>
                    </td>
        ...
        <form action="<?php  echo base_url(); ?>/home/checkout" method="post">
            <div class="col-md-6">
                <div class="form-group">
                   <input class="form-control" type="text"  name="cart_total" value="22" placeholder="NAME"><br>  
                </div>
            </div>
            <div class="col-md-6">
                <div class="form-group">
            ...
            <div class="col-md-12" style="text-align: center;">
                <div class="form-group">
                    <input type="submit" name="submit" value="Pay now Rs. 75,000" class="my_btn" style="font-size: 14px;">
