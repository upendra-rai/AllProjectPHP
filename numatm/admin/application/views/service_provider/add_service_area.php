						...
						<section class="section_card" id="table_section">
									...
									<div class="col-md-6">
										<div class="form-group">
											<div class="col-md-12">
												<input type="text" class="form-control" name="service_area_name" value="<?php if(isset($selected_service_area[0])){ echo $selected_service_area[0]->service_area_name; } ?>"  required><span class="placeholder">Service Area Name</span>
											</div>
										</div>
								     </div>
                                   ...
                                   <div class="col-md-6">
										<div class="form-group">
											<div class="col-md-12">
												<input type="text" class="form-control" name="service_area_code" value="<?php if(isset($selected_service_area[0])){ echo $selected_service_area[0]->service_area_code; } ?>"  required><span class="placeholder">Service Area Code</span>
											</div>
										</div>
								     </div>
                                    <div class="col-md-6">
										<div class="form-group">
											<div class="col-md-12">
												<input type="text" class="form-control" name="expiry_date" value="<?php if(isset($selected_service_area[0])){ echo $selected_service_area[0]->expiry_date; } ?>"  required><span class="placeholder">Expiry Date</span>
											</div>
										</div>
								     </div>
									...
									<div class="col-md-2">
											<div class="form-group">
												<div class="col-md-12">
												<a href="<?php echo base_url(); ?>master/service_area_code">	<button type="button" class="btn-transparent btn-red"  style=" width:100%;">Cancel</button></a>
												</div>
											</div>
										</div>
						             </div>
