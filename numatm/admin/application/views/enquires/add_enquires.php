						...
						<section class="section_card" id="table_section">
									...
									<div class="col-md-6">
										<div class="form-group">
											<div class="col-md-12">
												<input type="text" class="form-control" name="required_number" value=""  required><span class="placeholder">Required Number</span>
											</div>
										</div>
								     </div>
                                   ...
                                   <div class="col-md-6">
										<div class="form-group">
											<div class="col-md-12">
												<input type="text" class="form-control" name="customer_budget" value=""  required><span class="placeholder">Budget</span>
											</div>
										</div>
								     </div>
                                    ...
                                    <div class="col-md-6">
										<div class="form-group">
											<div class="col-md-12">
												<input type="text" class="form-control" name="enquiry_type" value=""  required><span class="placeholder">Enquires Type</span>
											</div>
										</div>
								     </div>
                                    <div class="col-md-6">
										<div class="form-group">
											<div class="col-md-12">
												<input type="text" class="form-control" name="customer_name" value=""  required><span class="placeholder">Customer Name</span>
											</div>
										</div>
								     </div>
                                            <div class="col-md-6">
										<div class="form-group">
											<div class="col-md-12">
												<input type="text" class="form-control" name="customer_mobile_no" value=""  required><span class="placeholder">Customer Mobile </span>
											</div>
										</div>
								     </div>
                                            <div class="col-md-6">
										<div class="form-group">
											<div class="col-md-12">
												<input type="text" class="form-control" name="customer_email" value=""  required><span class="placeholder">Customer Email</span>
											</div>
										</div>
								     </div>
                                       <div class="col-md-6">
										<div class="form-group">
											<div class="col-md-12">
												<input type="text" class="form-control" name="customer_city" value=""  required><span class="placeholder">Customer City</span>
											</div>
										</div>
								     </div>
                                            <div class="col-md-6">
										<div class="form-group">
											<div class="col-md-12">
												<input type="text" class="form-control" name="enquiry_source" value=""  required><span class="placeholder">Enquiry Source</span>
											</div>
										</div>
								     </div>
                                       <div class="col-md-12">
									...
									<div class="col-md-2">
											<div class="form-group">
												<div class="col-md-12">
												<a href="<?php echo base_url(); ?>enquires/enquires_details">	<button type="button" class="btn-transparent btn-red"  style=" width:100%;">Cancel</button></a>
												</div>
											</div>
										</div>
						             </div>
