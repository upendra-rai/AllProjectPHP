...
class model_search_customer extends CI_Model {
    ...
    public function searchbar_like_colony($search_by,$search_for){
				...
				if($data->num_rows() > 0){
		          foreach($data->result() as $row){
					  echo '<ul class="match_result_ul">';
                      echo '<li class="search_li" data-li_link="'.$row->customer_id.'" data-li_name="'.$row->customer_name.'">';
                      echo '<div class="inline-box"><i class="fa fa-search"></i></div>';
                      echo '<div class="inline-box">';
                      echo '<p class="search_title">'.$row->customer_name.'</p>';
                      echo '<p class="search_subtitle">'.$row->mobile_no.' <span>('.$row->colony_name.')</span></p>';
                      echo '</div>';
                      echo '<div class="inline-box">';
                      echo '<p class="search_title"></p>';
                      echo '</div>';
	...
	public function searchbar_list_name($search_by,$firstname,$lastname){
                ...
                if($lastname == ""){
                    ...
                    $this->db->like("customer_name", $firstname);
				    
                }else{
                    
                    $this->db->like("customer_name", $firstname.' '.$lastname);
