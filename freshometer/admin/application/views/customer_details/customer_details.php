                                ...
                                <table id="table" data-toggle="table" data-pagination="true"  
									...
									<tr>
									 ...
									 <tbody class="team_tbody">
                                         <?php $i=1; foreach($customer_list as $row){?>
                                             <tr>
                                                 <td><?php echo $i++; ?></td>
                                                 ...
                                                 <td><?php echo $row->customer_area_name; ?></td>
                                                 ...
                                                 <a href="<?php echo base_url(); ?>/customer_details/customer_view/<?php echo $row->customer_id; ?>"> <button data-toggle="tooltip" title="Edit" class="pd-setting-ed myedit" style="background-color:#14eb70;"><i class="fa fa-eye" aria-hidden="true" ></i></button></a>
                                                <?php } ?>     
                                                 </td>
                                              </tr>
