                            ...
                            <div class="row" id="my_table_body">
                                <?php foreach($detail as $row){ ?>
							     <div class="col-md-6">
                                     <div class="detail_box first">
                                         ...
                                         <img src="<?php echo base_url('catalogs') ?>/img/customer_img/<?php echo $row->customer_name; ?>" class="thumbnail" alt="" style="width:120px; height:120px; border-radius: 50%;" />
                                         <p style="font-weight:600; color:#0798dc;"><label>Name:&nbsp;</label> <?php echo $row->customer_name.' '.$row->customer_name; ?></p>
                                         <p><label>Email Address:&nbsp;</label> <?php echo $row->customer_name; ?></p>
                                         <p><label>Phone:&nbsp;</label> <?php echo $row->customer_contact; ?></p>
                                         
                                         <p><label>Address:&nbsp;</label><?php echo $row->customer_name; ?></p>
                                         

                                         <p style="font-weight:600; color:#0798dc;"><label>Colony Name:&nbsp;</label> <?php echo $row->customer_name; ?></p>
                                         <p><label>City:&nbsp;</label> <?php echo $row->customer_name; ?></p>
                                         <p><label>Shift:&nbsp;</label> <?php echo $row->customer_name; ?></p>
                                         
                                        <p><label>Delivery Schedule:&nbsp;</label> <?php echo $row->customer_name; ?></p>
                                         
                                        
                                         
                                         <p style="display:none;"><label>Delivery Type:&nbsp;</label> <?php echo $row->customer_name; ?></p>
                                         <p><label>Assigned Agent:&nbsp;</label> <?php echo $row->customer_name; ?></p>
                                         <p><label>Password:&nbsp;</label><span><button type="button" class="btn" id="show_cus_pass" style="background-color:transparent; border:none;"><i class="ion-eye"></i></button></span> <input type="password" id="cus_pass" value="<?php echo $row->customer_name; ?>" autocomplete="new-password" style="border:none; background-color:transparent;"> </p>
                                     </div>
                                ...
                                <div class="col-md-6">
                                         <div class="detail_box second" style="border-right: 1px solid transparent;">
                                             <input type="hidden" id="current_balance_amount" value="<?php echo $row->customer_name; ?>" />
                                         <p class="box_title ">Account Details</p>
                                              <p style="font-weight:600; color:#0798dc;"><label>Card No:&nbsp;</label> <?php echo $row->customer_name; ?></p>
                                              <p style="font-weight:600; color:#0798dc;"><label>Balance: &nbsp; <i class="fa fa-rupee" style="color:#0798dc;"></i></label> <?php echo $row->customer_name; ?></p>
                                              <p><label>Ragistration Date:&nbsp;</label> <?php echo date('d-M-y', strtotime($row->customer_name)); ?></p>
                                               <p><label>Account Type:&nbsp;</label> <?php echo $row->customer_name; ?> </p>
                                             <p><label>Account Restriction:&nbsp;</label> <?php echo $row->customer_name; ?> </p>
                                              <p><label>Status:&nbsp;</label> <?php echo $row->customer_name; ?> </p>
                                              <br>
                                               ...
                                               <div class="sparkline15-graph" style="padding-left:15px;">
                                                  <div class="row">
                                                        <div class="switch_style"style="">
                                                            ...
                                                            <label class="switch">
                                                                <input type="checkbox" id="update_status" data-status_id="<?php echo $row->customer_id; ?>" <?php if($row->customer_id == "blocked"){ echo "checked";}  ?>/>
                                                        ...
                                                        <div class="input-group custom-go-button">
                                                            ...
                                                            <span class="input-group-btn"><button type="button" id="recharge_bt" data-minimum_recharge="<?php if(isset($minimum_recharge[0])){ echo $minimum_recharge[0]->customer_name; }else{ echo '500'; } ?>" data-recharge_id="<?php echo $row->customer_id; ?>" data-status="<?php echo $row->customer_name; ?>" data-mobile="<?php echo $row->customer_name; ?>" class="btn btn-primary" style="height:43px;">RECHARGE</button></span>
													  ...
													  <br>
                                                       ...
                                                       <a href="<?php echo base_url() ?>customer_details/customer_edit/<?php echo $row->customer_id; ?>"><button data-toggle="tooltip" title="Edit Profile" class="btn btn-primary action_panel_bt" style="background-color:#3f51b5; "><i class="fa fa-pencil-square" style="font-size:22px;"></i> Edit Profile</button></a>
                                                      <a href="<?php echo base_url() ?>customer/assign_card/<?php echo $row->customer_id; ?>"><button data-toggle="tooltip" title="Change ATM Card" class="btn btn-primary action_panel_bt" style="background-color:#3f51b5; "><i class="fa fa-credit-card" style="line-height:25px;"></i>Change ATM Card</button></a>
                                                        <button data-toggle="tooltip" id="terminate" title="Terminate Account" data-del_id="<?php echo $row->customer_id; ?>" data-del_name="<?php echo $row->customer_name.' '.$row->customer_name; ?>" data-del_return_amount="<?php echo $row->customer_name; ?>" class="btn btn-primary action_panel_bt" style="background-color:#e91e63; "><i class="ion-ios-minus"></i> Terminate Account</button>
