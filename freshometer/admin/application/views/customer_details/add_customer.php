                                                        ...
                                                        <div class="row">
                                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                                <div class="input-group">
                                                                    ...
                                                                    <input name="customer_name"  type="text" class="form-control" value="<?php if(isset($selected_customer[0])){ echo $selected_customer[0]->customer_name; } ?>" placeholder="Name" required>
                                                                </div>
                                                                <div class="input-group">
																    <span class="input-group-addon"><i class="fa fa-envelope-o"></i></span>
                                                                    <input name="customer_contact"  type="text" class="form-control" value="<?php if(isset($selected_customer[0])){ echo $selected_customer[0]->customer_contact; } ?>" placeholder="Contact No" >
                                                                </div>
                                                                <div class="input-group">
																    <span class="input-group-addon"><i class="ion-social-whatsapp-outline" style="font-size: 18px;"></i></span>
                                                                    <input name="customer_address" id="customer_address" type="text" class="form-control" value="<?php if(isset($selected_customer[0])){ echo $selected_customer[0]->customer_address; } ?>" placeholder="Address."  >
                                                                </div>
                                                    <div class="input-group">
												     <span class="input-group-addon"><i class="ion-ios-paperplane-outline" style="font-size: 24px;"></i></span>
                                                    <select class="form-control" name="customer_area_id"   >
													  <option value="">Area</option>
													 <?php foreach($area_list as $row){ ?>
													 <option value="<?php echo $row->customer_area_id; ?>" <?php if(isset($selected_customer)){  if($selected_customer[0]->customer_id == $row->customer_area_id){echo 'selected';  }else{ echo ''; }   } ?>     ><?php echo $row->customer_area_name; ?></option>
													<?php } ?>
												    </select>
                                                        </div>
                                                    </div>
                                                            ...
                                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                               ...
                                                               <div class="input-group">
                                                                 ...
                                                                 <option value="<?php echo $row->plan_id; ?>" <?php if(isset($selected_customer)){  if($selected_customer[0]->customer_id == $row->plan_id){echo 'selected';  }else{ echo ''; }   } ?>     ><?php echo $row->plan_name; ?></option>
                                                                <?php } ?>
                                                                </select>
                                                                </div>
                                                                <div class="input-group">
																    <span class="input-group-addon"><i class="ion-ios-locked-outline" style="font-size: 20px;"></i></span>
                                                                    <input name="reference"  type="text" class="form-control" value="<?php if(isset($selected_customer[0])){ echo $selected_customer[0]->reference; } ?>" placeholder="Reference"  >
                                                                </div>
                                                                <div class="input-group">
																    <span class="input-group-addon"><i class="ion-ios-locked-outline" style="font-size: 20px;"></i></span>
                                                                    <input name="customer_password"  type="text" class="form-control" value="<?php if(isset($selected_customer[0])){ echo $selected_customer[0]->customer_password; } ?>" placeholder=" Password" required  >
                                                             ...
                                                             <option value="">Gender</option>
                                                              <option value="male"  <?php if(isset($selected_customer[0])){ if($selected_customer[0]->customer_gender == 'male'){ echo 'selected'; } } ?> >Male</option>
                                                              <option value="female" <?php if(isset($selected_customer[0])){ if($selected_customer[0]->customer_gender == 'female'){ echo 'selected'; } } ?>>Female</option>
                                                               </select> 
                                                                </div>
                                                            </div>
                                                            <div class="row">
