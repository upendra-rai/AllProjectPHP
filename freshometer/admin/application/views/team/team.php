									 ...
									 <tbody class="team_tbody">
                                         <?php $i=1; foreach($team as $row){?>
                                             <tr>
										         ...
										         <td>
                                                 <a href="<?php echo base_url(); ?>/team/edit_team/<?php echo $row->user_id; ?>"> <button data-toggle="tooltip" title="Edit" class="pd-setting-ed myedit" style="background-color:#2196f3;"><i class="fa fa-pencil" aria-hidden="true" ></i></button></a>
                                                 </td>
										         <td>
                                                <?php if($row->role == 'Agent'){ ?>     
                                                 <a href="<?php echo base_url(); ?>/team/assign_colony/<?php echo $row->user_id; ?>/<?php echo $row->name; ?>"> <button data-toggle="tooltip" title="Edit" class="pd-setting-ed myedit" style="background-color:#14eb70;"><i class="fa fa-map" aria-hidden="true" ></i></button></a>
                                                <?php } ?>     
                                                 </td>
                                              </tr>
                                         <?php } ?>
