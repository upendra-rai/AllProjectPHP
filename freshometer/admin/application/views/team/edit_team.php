                                                        ...
                                                        <div class="row">
                                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                                <div class="input-group">
                                                                    ...
                                                                    <input name="up_teamname" type="text" class="form-control" value="<?php if(isset($team_name)){ echo $team_name; }else{ echo $team_edit[0]->name; } ?>" placeholder="Name" required>
                                                                </div>
                                                                <div class="input-group">
																    <span class="input-group-addon"><i class="fa fa-envelope-o"></i></span>
                                                                    <input name="up_team_email" type="email" class="form-control" value="<?php if(isset($team_email)){ echo $team_email; }else{ echo $team_edit[0]->email; } ?>" placeholder="Email Address" >
                                                                </div>
                                                                <div class="input-group">
																    <span class="input-group-addon"><i class="ion-social-whatsapp-outline"></i></span>
                                                                    <input name="up_team_number" type="text" class="form-control" value="<?php if(isset($team_number)){ echo $team_number; }else{ echo $team_edit[0]->contact; } ?>" placeholder="Mobile No." minlength="10" onkeydown="validateNumber(event);" required>
                                                                </div>
                                                                <div class="input-group">
                                                                    <span class="input-group-addon"><i class="ion-ios-paperplane-outline" style="font-size: 24px;"></i></span>
                                                                    <select name="up_teamrole" class="form-control" style="width:100%;" required>
                                                                        <option value="Agent" >Agent</option>
                                                                        <option value="Counter">Counter</option>
                                                                    </select>
                                                                    
                                                                    <input   type="hidden" id="return_role" class="form-control" value="<?php if(isset($team_role)){ echo $team_role; }else{ echo $team_edit[0]->role; } ?>" placeholder="Role" required />
                                                            ...
                                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                                ...
                                                                <div class="input-group">
																    <span class="input-group-addon"><i class="ion-ios-paperplane-outline" style="font-size: 24px;"></i></span>
                                                                    <input name="up_user_name"  type="text" class="form-control" value="<?php if(isset($user_name)){ echo $user_name; }else{ echo $team_edit[0]->user_name; } ?>" placeholder="User Name" required autocomplete="new-password"/>
                                                                ...
                                                                <div class="input-group">
                                                                    ...
                                                                    <input name="up_pass1" type="password" class="form-control" value="<?php if(isset($pass)){ echo $pass; }else{ echo $team_edit[0]->password; } ?>" placeholder="New Password" required autocomplete="new-password">
                                                                </div>
                                                                <div class="input-group">
																    <span class="input-group-addon"><i class="ion-ios-locked-outline" style="font-size: 20px;"></i></span>
                                                                    <input name="up_pass2"  type="password" class="form-control" value="<?php if(isset($pass)){ echo $pass; }else{ echo $team_edit[0]->password; } ?>" placeholder="Retype password" required autocomplete="new-password">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-lg-12">
                                                                <div class="payment-adress" >
                                                                    ...
                                                                    <button id="edit_team_bt" type="submit" title="submit"  class="btn btn-primary waves-effect waves-light" style="background-color:#2c6be0;">Submit</button>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </form>
                            ...
                            <div class="modal-dialog" style="width:90%;">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body" style="padding: 30px 30px;">
                                        ...
                                        <h2>Awesome!</h2>
                                        <p>Team Member Is Successfully Updated</p>
                                    </div>
...
function validateNumber(evt) {
	...
	$(document).ready(function(){
		...
		$(document).on('click','#edit_team_bt1',function(){
			$('#my_loader').show();
            var team_id = $(this).data("edit_id");
            
			var up_name = $('input[id=up_team_name]').val();
			var up_email = $('input[id=up_team_email]').val();
			var up_mobile = $('input[id=up_team_number]').val();
            
            if(up_name == "" || up_email == "" || up_mobile == ""){
                
                alert("fille required field");
            }else{
			$.ajax({
				type: "POST",
				url: '<?php echo base_url(); ?>team/edit_submit',
        ...
        $(document).on('keyup','input[name=up_pass2]',function(){
             var pass1 = $('input[name=up_pass1]').val();
             var pass2 = $('input[name=up_pass2]').val();
        ...
        $(document).on('keyup','input[name=up_pass1]',function(){
             var pass1 = $('input[name=up_pass1]').val();
             var pass2 = $('input[name=up_pass2]').val();
         ...
         function select_role(){
            ...
            $('select[name=up_teamrole]').val(role_select);
