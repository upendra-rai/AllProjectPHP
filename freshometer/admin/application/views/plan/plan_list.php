									 ...
									 <tbody class="team_tbody">
                                         <?php $i=1; foreach($plan_list as $row){?>
                                             <tr class="list_tr">
                                                 ...
                                                 <td><?php echo $row->duraction; ?> Day</td>
                                                  <td> <span class="rs_span">&#8377 </span> <?php echo $row->cost; ?></td>
                                                  <td><?php echo $row->total_tifin_qty; ?></td>
                                                 <td><span class="rs_span">&#8377 </span> <?php echo $row->per_tifin_price; ?></td>
                                                 <td><?php if($row->plan_breakfast == 'yes'){ echo 'Breakfast ,'; }; ?> <?php if($row->plan_launch == 'yes'){ echo 'Launch ,'; }; ?> <?php if($row->plan_dinner == 'yes'){ echo 'Dinner'; }; ?>  </td>
                                                 <td ><p style="text-transform: capitalize;"><?php echo $row->plan_status; ?></p></td>
										         <td>
                                                     <a href="<?php echo base_url(); ?>plan/edit_plan/<?php echo $row->plan_id; ?>"><button data-toggle="tooltip" title="Edit" id="update" data-update_id="" class="pd-setting-ed myedit"><i class="fa fa-pencil" aria-hidden="true" ></i></button></a>
                                                 </td>
                                                 
                                                 <td>
                                                 <button data-toggle="tooltip"  id="del_row" data-del_id="<?php echo $row->plan_id; ?>" class="pd-setting-ed mydelete"><i class="fa fa-trash" aria-hidden="true" ></i></button>
                                                 </td>
