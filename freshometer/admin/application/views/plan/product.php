									 ...
									 <tbody class="team_tbody">
                                         <?php $i=1; foreach($product_list as $row){?>
                                             <tr class="list_tr">
										         ...
										         <td>
                                                     <a href="<?php echo base_url(); ?>plan/edit_product/<?php echo $row->product_id; ?>"><button data-toggle="tooltip" title="Edit" id="update" data-update_id="" class="pd-setting-ed myedit"><i class="fa fa-pencil" aria-hidden="true" ></i></button></a>
                                                 </td>
                                                 
                                                 <td>
                                                 <button data-toggle="tooltip"  id="del_row" data-del_id="<?php echo $row->product_id; ?>" class="pd-setting-ed mydelete"><i class="fa fa-trash" aria-hidden="true" ></i></button>
                                                 </td>
    ...
    <script type="text/javascript">
        ...
        $(document).on('click','button[id=del_row]',function(){
         ...
         $(document).on('click','button[id=del_model_bt]',function(){
			...
			$.ajax({
				 type: 'POST',
				 url: '<?php echo base_url(); ?>plan/delete_product',
