                            ...
                            <div class="asset-inner">
                                ...
                                <table id="table" data-toggle="table" data-pagination="true" data-show-columns="true" data-show-pagination-switch="true"  data-key-events="true" data-show-toggle="true"  data-cookie="true"
                                    ...
                                    <?php $i = 1; if(isset($all_customer)){ foreach($all_customer as $row){ ?>     
                                      ...
                                      <tr data-customer_id="<?php echo $row->my_customer_id; ?>">
                                          
                                       <td> <?php echo $i++; ?></td>      
                                       <td><?php echo $row->customer_name?></td> 
                                          <td><?php if($row->subscribed_plan_status == 'active'){ echo $row->plan_name; }else if($row->subscribed_plan_status == 'inactive'){ echo '<p style="color:#f80750; font-weight:600;">Expired</p>';  }else{ ?> <p style="color:#46c7fe; font-weight:550;">No</p> <?php } ?></td>        
                                       ...
                                       <td><span class="rs_span">&#8377 </span><?php echo $row->balance_amount; ?></td>       
   ...
   <script type="text/javascript">
    $(document).ready(function(){
        $(document).on('click','#customer_table tr',function(){
             ...
             window.location.href = '<?php echo base_url() ?>report/customer_full_transaction_report/'+linked_id;
		 }); 
