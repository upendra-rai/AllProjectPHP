                                          ...
                                          <div class="chosen-select-single mg-b-20">
                                                ...
                                                <?php if(isset($all_customer_list)){ foreach($all_customer_list as $row){ ?>
                                                    <option value="<?php echo $row->customer_id; ?>">
                                                      <?php echo $row->customer_name; ?><?php echo $row->mobile_no; ?>
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" >
                            ...
                            <div style="padding-top:10px; font-size: 17px; color:#262d31;">
                               ...
                               <table id="table" data-toggle="table" data-show-columns="true" data-show-pagination-switch="true"  data-key-events="true" data-show-toggle="true"  data-cookie="true"
    							 ...
    							 <tbody id="tran_table">
                                  <?php $i = 1; $total = 0; foreach($order_report as $row){ ?>
                                    ...
                                    <tr>
                                       ...
                                       <td><?php echo $row->customer_name; ?></td>
                                        ...
                                        <td><?php if($row->shift_id == 1){ echo 'Breakfast'; }else if($row->shift_id == 2){  echo 'Launch'; }else if($row->shift_id == 3){ echo 'Dinner'; } ?></td>
                                        
                                        <td><i class="fa fa-rupee" style="color:#46c7fe;"></i> <?php echo $row->tiffin_cost; $total += $row->tiffin_cost; ?></td>
                                  ...
                                  <tfoot>
                                            ...
                                            <tr>
                                                ...
                                                <td style="border:1px solid #dddddd;"></td>
                                                 <td style="border:1px solid #dddddd;"></td>
                                                 <td style="border:1px solid #dddddd;"></td>
                                                 <td style="border:1px solid #dddddd;"><i class="fa fa-rupee" style="color:#46c7fe;"></i> <?php echo $total; ?></td>
