                                                        ...
                                                        <div class="row">
                                                            <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                                                                <div class="input-group">
                                                                    ...
                                                                    <input name="product_name" id="product_name" type="text" class="form-control" value="" placeholder="Product Name" required onkeypress="return onlyAlphabets(event,this);">
									 ...
									 <tbody class="team_tbody">
                                         <?php $i=1; foreach($product as $row){?>
                                             <tr class="list_tr">
                                                 ...
                                                 <td class="name_td"><?php echo $row->menu_name; ?></td>
										         <td>
