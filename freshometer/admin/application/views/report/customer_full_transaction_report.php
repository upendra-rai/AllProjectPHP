               ...
               <div class="product-status-wrap mycard" style="overflow:auto; overflow-X:hidden; padding:10px;  border-top:1px solid #0b89de; box-shadow: 0px 3px 8px -1px rgba(0,0,0,0.4); ">
                  <div class="row detail_tab">
                      <div class="col-md-4" style="height:99px;">
                         <p style="margin:0;"><label>Name:</label> <?php echo $customer_detail[0]->customer_name; ?></p>
                         <p style="margin:0;"><label>Phone 1:</label> <?php echo $customer_detail[0]->mobile_no; ?></p>
                         <p style="margin:0;"><label>Phone 2:</label> <?php echo $customer_detail[0]->mobile_no2; ?></p>
                         <input type="hidden" id="search_customer_id" value="<?php echo $customer_detail[0]->customer_id; ?>">
                      </div>                                        
                      <div class="col-md-4" style="height:99px;">
                         <p style="margin:0;"><label>Address 1:</label> <?php echo $customer_detail[0]->address_one; ?></p>
                         <p style="margin:0;"><label>Colony Name:</label> <?php echo $customer_detail[0]->colony_name; ?></p>
                         <p style="margin:0;"><label>Balance:</label> <span class="rs_span" style="color:#46c7fe;">&#8377 </span> <?php echo number_format($customer_detail[0]->balance_amount); ?></p>
                      </div>
                      <div class="col-md-4" style="height:99px;">
                          <p style="margin:0;"><label>Ragistration Date:</label> <?php echo date('d-M-y',strtotime($customer_detail[0]->ragistration_date)); ?></p>
                          <p style="margin:0; text-transform: capitalize;"><label>Status:</label> <?php echo $customer_detail[0]->customer_status; ?></p>
                      </div>
                  </div>
               </div>
           </div>
