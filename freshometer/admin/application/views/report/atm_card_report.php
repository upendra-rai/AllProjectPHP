                                           ...
                                           <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12" >
                                             <div class="form-group" id="data_5" style=" height:28px;">
                                                  <select name="status_search" class="form-control" style="width:100%;">
                                                      <option value="">Tifin Status</option>
                                                      <option value="available">Available</option>
                                                      <option value="assigned">Assigned</option>
                                                      <option value="delivered">Delivered</option>
                                                      <option value="unscan">UnScaned</option>
                            ...
                            <div class="asset-inner" >
                                ...
                                <table id="table" data-toggle="table" data-pagination="true" data-show-columns="true" data-show-pagination-switch="true"  data-key-events="true" data-show-toggle="true"  data-cookie="true"
									...
									<tr>
										...
										<th>Customer Name</th>
                                        <th>Shift</th>
                                        <th>Tifin Assigned Date</th>
                                        <th>Last Scan Date</th>
                                        <th>Last Scaned By</th>
										<th>Mobile No</th>
                                    </tr>
									 </thead>
									 <tbody id="myTable">
                                    <?php $i = 1; if(isset($atm_card_report)){ foreach($atm_card_report as $row){ ?>     
                                      ...
                                      <tr data-customer_id="<?php echo $row->customer_id; ?>">
                                       ...
                                       <td><?php 
                                             if($row->tifin_status == 'morning' || $row->tifin_status == 'evening' )
                                             { echo '<p class="green_status">Assigned</p>';
                                             }else if($row->tifin_status == 'lost')
                                             { echo '<p class="red_status">Lost</p>'; 
                                             }else if($row->tifin_status == 'broken')
                                             { echo '<p class="red_status">Broken</p>'; 
                                             }else if($row->tifin_status == 'blocked')
                                             { echo '<p class="yellow_status">Blocked</p>'; 
                                             }else if($row->tifin_status == '')
                                             { echo '<p class="blue_status">Available</p>';} ?></td>
                                       <td><?php echo $row->assign_name; ?></td>
                                       <td><?php echo $row->tifin_status; ?></td>    
                                       <td><?php if($row->tifin_assign_time != '0000-00-00 00:00:00'){ echo date('d-M-Y h:i a',strtotime($row->tifin_assign_time)); } ?></td>
                                       <td><?php if($row->last_transaction_date != '0000-00-00 00:00:00'){ echo date('d-M-Y h:i a',strtotime($row->last_transaction_date)); } ?></td> 
                                          <td><?php echo $row->scaned_by; ?></td> 
                                          <td><?php echo $row->scaned_by_mobile_no; ?></td>
                                       </tr>
									<?php }} ?>
									</tbody>
								</table>
