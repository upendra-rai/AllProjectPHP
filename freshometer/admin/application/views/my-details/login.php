...
<head>
	...
	<style type="text/css">
	.login_logo{
	width:120px;   position:relative; z-index:999;
	margin-bottom:15px;
	...
	<div class="error-pagewrap">
		<div class="error-page-int">
			...
			<div class="content-error">
			    ...
			    <img class="login_logo" src="<?php echo base_url('catalogs'); ?>/img/logo4.png" alt=""/>
			</div>
					    <div class="text-center m-b-md custom-login">
				          <h3>Fresh'o Meter Login Section</h3>
