                                ...
                                <div class="input-group"  style=" width:100%;">
                                        ...
                                        <form action=""  method="post" >
                                           <div class="col-lg-10 col-md-10 col-sm-12 col-xs-12" >
                                                ...
                                                <p style="width:100%; height:30px; color:#ffffff; background-color:#fa0c23; padding: 3px 10px; text-align:center; display:none;" id="fail_noti">
                                                   Process is failed!
                                               </p> 
                                               <!-- 
                    ...
                    <div class="col-md-12">
                            ...
                            <div class="asset-inner">
                                ...
                                <table id="" data-toggle="table" data-pagination="true" data-show-columns="true" data-show-pagination-switch="true" >
									...
									<tr>
                                        <th>Sr. No.</th>
                                        <th><input type="checkbox" name="check_all" id="check_all" name=""> Check </th>
                                        <th>Customer Name</th>
								        <th>Colony</th>
                                        <th>Address</th>
                                        <th>Phone 1</th>
                                    ...
                                    <?php $i = 1; if(isset($all_customer)){ foreach($all_customer as $row){ ?>     
                                      ...
                                      <tr data-customer_id="<?php echo $row->customer_id; ?>">
                                       ...
                                       <td><?php echo $i++; ?></td> 
                                       <td> <input type="checkbox" name="check" value="<?php echo $row->customer_id; ?>" data-cus_no="<?php echo $row->mobile_no; ?>">
                                       </td>       
                  ...
                  $.ajax({
						...
						success: function(data){
							...
							if(data === 'success'){
							   ...
							   $('#fail_noti').slideDown("1000");
                               $('#submit_notification').val('Send');
                               setTimeout(function(){  $('#fail_noti').slideUp("1000"); }, 2000);
