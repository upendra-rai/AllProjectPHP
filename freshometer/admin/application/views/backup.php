...
<body>
    ...
    <div class="all-content-wrapper">
		...
		<div class="container-fluid" style="margin-top:35px;">
            ...
            <a href="<?php echo base_url(); ?>dashboard/db_backup"><button class="btn btn-primary" style="background-color:#0099cc; border:1px solid #0099cc;"> Create Backup</button></a>
