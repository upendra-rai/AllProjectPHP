						...
						<section class="section_card" id="table_section">
									...
									<div class="col-md-6">
										<div class="form-group">
											<div class="col-md-12">
												<input type="text" class="form-control" name="profile_type_name" value="<?php if(isset($selected_profile[0])){ echo $selected_profile[0]->profile_type_name; } ?>"  required><span class="placeholder"> Profile Type Name</span>
											</div>
										</div>
								     </div>
									...
									<div class="col-md-2">
											<div class="form-group">
												<div class="col-md-12">
												<a href="<?php echo base_url(); ?>master/profile_details">	<button type="button" class="btn-transparent btn-red"  style=" width:100%;">Cancel</button></a>
												</div>
											</div>
										</div>
						             </div>
