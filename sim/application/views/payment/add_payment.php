						...
						<section class="section_card" id="table_section">
                                ...
                                <select class="form-control" name="payment_type">
                                 <option value="">Payment Type</option>
                                  <option value="new"  <?php if(isset($r_status)){ if($r_status == 'new'){ echo 'selected'; } } ?> >New</option>
                                  <option value="refund" <?php if(isset($r_status)){ if($r_status == 'refund'){ echo 'selected'; } } ?>>Refund</option>
                                  </select>
                                    </div>
                                    </div>
                                </div>
										...
										<div class="form-group">
											<div class="col-md-12">
                                                <select class="form-control" name="order_id" required>
                                                             ...
                                                             <?php if(isset($order_list)){ foreach($order_list as $row){ ?>
                                                             <option value="<?php echo $row->online_order_id; ?>"  ><?php echo $row->online_order_id; ?></option>
                                                                  <?php }}  ?>
                                                </select>	
											</div>
										</div>
                                ...
                                <div class="col-md-6">
										<div class="form-group">
											<div class="col-md-12">
												<input type="text" class="form-control" name="transction_id" value=""  required><span class="placeholder"> Transction Id</span>
											</div>
										</div>
								     </div>
                                    <div class="col-md-6">
										<div class="form-group">
											<div class="col-md-12">
												<input type="text" class="form-control" name="amount" value=""  required><span class="placeholder">Amount</span>
											</div>
										</div>
								     </div>
                                         ...
                                         <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <select class="form-control" name="payment_method" required>
                                                             ...
                                                             <?php if(isset($payment_method_list)){ foreach($payment_method_list as $row){ ?>
										...
										<div class="form-group">
											<div class="col-md-12">
												<input type="text" class="form-control" name="payment_status" value=""  required><span class="placeholder"> Payment Status</span>
											</div>
										</div>
								     </div>
                                    ...
                                    <div class="col-md-6">
										<div class="form-group">
											<div class="col-md-12">
												<input type="text" class="form-control" name="payment_note" value=""  required><span class="placeholder"> Remark</span>
											</div>
										</div>
								     </div>
