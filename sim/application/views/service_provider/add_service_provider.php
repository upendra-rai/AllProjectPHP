						...
						<section class="section_card" id="table_section">
									...
									<div class="col-md-6">
										<div class="form-group">
											<div class="col-md-12">
												<input type="text" class="form-control" name="service_provider_name" value="<?php if(isset($selected_service_provider[0])){ echo $selected_service_provider[0]->service_provider_name; } ?>"  required><span class="placeholder">Service Provider Name</span>
											</div>
										</div>
								     </div>
                                   ...
                                   <div class="col-md-6">
										<div class="form-group">
											<div class="col-md-12">
												<input type="text" class="form-control" name="service_provider_code" value="<?php if(isset($selected_service_provider[0])){ echo $selected_service_provider[0]->service_provider_code; } ?>"  required><span class="placeholder">Service Provider Code</span>
											</div>
										</div>
								     </div>
