                                        ...
                                        <div class="col-md-12">
										  ...
										  <div class="form-group">
											   <div class="col-md-12">
												 ...
												 <label for="file" id="img_label" style="width:150px; height:150px; border:1px solid #424351; text-align:center;  font-size:25px;"><?php if(isset($selected_brand[0])){ ?> <img src="<?php echo base_url(); ?>uploads/brand_img/<?php echo $selected_brand[0]->brand_img; ?>" data-img_name="" alt="" style="width:100% ; height:100%;"/><input type="hidden" name="brand_img" value="<?php echo $selected_brand[0]->brand_img; ?>" /><button type="button" class="btn" id="temprory_remove_image" style="position:absolute; background-color:#ff4747; color:#ffffff; margin-top:-2px;">X</button>  <?php }else{ ?> <i class="fa fa-globe" style="margin-top:60px; margin-right:5px;"></i><span style="font-size:12px; ">Browse</span> <?php  } ?>  </label>
											   </div>
												 <!-- last uploaded image name -->
											   <input type="hidden" name="last_uploaded_image_name" value="<?php if(isset($selected_brand[0])){ echo $selected_brand[0]->brand_img; }?>">
										 </div>
									</div>        
    ...
    document.getElementById('file').addEventListener('change', (e) => {
        ...
        success(result) {
           ...
           formData.append('img_folder_name', img_folder_name);
            $.ajax({
		    	url: '<?php echo base_url(); ?>/management/upload_brand_image',
		    	method:"POST",
		    	data:formData,
		    	contentType:false,
		    	cache:false,
