						...
						<section class="section_card" id="table_section">
									...
									<div class="col-md-6">
										<div class="form-group">
											<div class="col-md-12">
												<input type="text" class="form-control" name="from_amount" value="<?php if(isset($selected_commission[0])){ echo $selected_commission[0]->from_amount; } ?>"  required><span class="placeholder">UPC Code</span>
											</div>
										</div>
								     </div>
                                   ...
                                   <div class="col-md-6">
										<div class="form-group">
											<div class="col-md-12">
												<input type="text" class="form-control" name="to_amount" value="<?php if(isset($selected_commission[0])){ echo $selected_commission[0]->to_amount; } ?>"  required><span class="placeholder"> Service Provider Name</span>
											</div>
										</div>
								     </div>
                                <div class="col-md-6">
										<div class="form-group">
											<div class="col-md-12">
												<input type="text" class="form-control" name="commission_percent" value="<?php if(isset($selected_commission[0])){ echo $selected_commission[0]->commission_percent; } ?>"  required><span class="placeholder">Service Provider Area</span>
											</div>
										</div>
								     </div>
                                    <div class="col-md-6">
										<div class="form-group">
											<div class="col-md-12">
												<input type="text" class="form-control" name="commission_rs" value="<?php if(isset($selected_commission[0])){ echo $selected_commission[0]->commission_rs; } ?>"  required><span class="placeholder"> Validity</span>
											</div>
										</div>
								     </div>
									...
									<div class="col-md-2">
											<div class="form-group">
												<div class="col-md-12">
												<a href="<?php echo base_url(); ?>master/commission">	<button type="button" class="btn-transparent btn-red"  style=" width:100%;">Cancel</button></a>
												</div>
											</div>
										</div>
						             </div>
