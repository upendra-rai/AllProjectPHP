				...
				<section role="main" class="content-body" >
						...
						<section class="section_card" id="table_section">
											...
											<div class="col-md-12">
                                                <select class="form-control" name="product_cod_available">
                                                 <option value="">Action</option>
                                                  <option value="Yes"  <?php if(isset($selected_product[0])){ if($selected_product[0]->product_cod_available == 'Yes'){ echo 'selected'; } } ?> >Update</option>
                                                  <option value="No" <?php if(isset($selected_product[0])){ if($selected_product[0]->product_cod_available == 'No'){ echo 'selected'; } } ?>>Delete</option>
                                             </select>
											</div>
										</div>
								     </div>
                                  <div class="col-md-6">
										<div class="form-group">
											<div class="col-md-12">
												<textarea type="text" class="form-control"  style="width: 300px;
                                                 height: 150px;" name="product_vanity_no" value="<?php if(isset($selected_product[0])){ echo $selected_product[0]->product_vanity_no; } ?>"  required>
