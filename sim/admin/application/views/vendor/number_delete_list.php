						...
						<section class="section_card" id="table_section">
										...
										<div class="form-group">
											<div class="col-md-12">
                                                <select class="form-control" name="order_id" required>
                                                             ...
                                                             <?php if(isset($name_list)){ foreach($name_list as $row){ ?>
                                ...
                                <div class="col-md-12">
									<div class="col-md-2">
											<div class="form-group">
												<div class="col-md-12">
												<a href="<?php echo base_url(); ?>vendor/delete_number/<?php echo $row->vendor_id; ?>" class="btn-transparent btn-red"  style=" width:100%;">Delete Vendor</a>
												</div>
											</div>
										</div>
									...
									<div class="col-md-2">
											<div class="form-group">
												<div class="col-md-12">
												<a href="<?php echo base_url(); ?>master/manage_category">	<button type="button" class="btn-transparent btn-white"  style=" width:100%;">Cancel</button></a>
												</div>
											</div>
										</div>
						             </div>
