								 ...
								 <header class="panel-heading" style="padding:0px 15px;">
								     	<div class="heading_box" style=" border-bottom: none; padding: 6px 2px; height:36px; background-color:#27293d;">
									        <h2 class="panel-title" style="color:#dbd6d6; font-size:16px; line-height:10px; text-transform:uppercase;">
														...
														<a href="<?php echo base_url(); ?>/payment/add_payment"type="btn" class="btn-transparent btn-green" style="position:absolute; right:12px; top:8px;">Update Pirority</a>
													</h2>
									    </div>
								</header>
								   ...
								   <table class="table mb-none" id="table" data-toggle="table" data-pagination="true" style="border-bottom: 1px solid #424351;">
									...
									<tbody>
										...
										<div class="form-group">
											<div class="col-md-12">
												<input type="text" class="form-control" name="" value="<?php echo $row->priority; ?>"  required><span class="placeholder"></span>
											</div>
										</div>
								     </div></td>
                                    <td>              
										...
										<div class="form-group">
											<div class="col-md-12">
												<input type="text" class="form-control" name="customer_name" value="<?php echo $row->priority_limit; ?>"  required><span class="placeholder"></span>
											</div>
										</div>
								     </div>
                                 </td>
