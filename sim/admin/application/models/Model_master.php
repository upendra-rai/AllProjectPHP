...
class model_master extends CI_Model {
	...
	public function employee_details(){
        ...
        $this->db->join('profile_type','profile_type.profile_type_id = employee.profile_type_id');
		$data = $this->db->get();
		return $data->result();    
    }
    ...
    $data = array(
       'employee_login_id' =>$employee_login_id,
        ...
        echo $employee_login_id.$employee_password.$employee_first_name.$employee_last_name.$employee_contact_number.$employee_email_id.$employee_profile.$time_stamp;
...
/*########################################ProductType######################################################################################################ProductType##########################################################*/
 //=========********===========********========******========//
    ...
    public function add_gst($gst_value){
         $data = array(
      'gst_value' =>$gst_value,
     ...
     //echo $brand_name;
      if($this->db->insert('gst',$data)){
        echo 'success';
          redirect(base_url().'/master/gst_details  ');
    ...
    public function selected_gst($edit_id){
        $this->db->select('*');
        $this->db->where('gst_id',$edit_id);
        $this->db->from('gst');
        $data = $this->db->get();
        return $data->result();
    }
    
    public function edit_gst($edit_id,$gst_value){
        $this->db->where('gst_id',$edit_id);
    $data = array(
     'gst_value' =>$gst_value,
     );
    ...
    public function delete_gst($del_id){
