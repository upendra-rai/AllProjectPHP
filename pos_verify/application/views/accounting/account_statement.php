...
<body>
                ...
                <div class="row">
                 ...
                 <div class="panel-body " style="padding-top:5px;">
                   ...
                   <div class="col-md-2" style="padding:6px;">
                     ...
                     <div class="form-group">
                          <input type="submit" class="btn btn-primary" name="submit" value="submit" style="width:100%;  height:32px; border-radius:5px; background-color:#0088cc; color:#ffffff;" />
                     </div>
                   </div>
                  <!-- <div class="col-md-2" style="padding:6px;">
                     <div class="form-group">
    ...
    <tr>
     ...
     <tbody id="customer_table">
                      <?php $i = 1; $total_credit = 0; $total_debit=0; $current_balance = 0; if(isset($list)){ foreach($list as $row){ ?>

                       <a href="<?php echo base_url(); ?>report/customer_full_report/<?php echo $row->id; ?>"> <tr>
                         ...
                         <td><?php echo $total_credit - $total_debit;  $current_balance = ($total_credit - $total_debit); ?></td>   
