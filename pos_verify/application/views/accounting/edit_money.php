						 ...
						 <div class="panel-body" style="padding-left:0px; padding-right:0px;  background-color:#27293d; padding-top:15px; padding-bottom:0px;">
								     ...
								     <div class="col-md-6"  >
										 <div class="form-group">
											 <div class="col-md-12">
												 <select class="form-control" name="from_account_id" <?php  if(!empty($from_account_list)){ echo 'required'; }  ?>  >
													  <option value="">From Account</option>
													 <?php foreach($from_account_list as $row){ ?>
													 <option value="<?php echo $row->account_name; ?>" <?php if(isset($selected_money)){ if($selected_money[0]->from_account_id == $row->account_id){ echo 'selected'; } if($selected_money[0]->from_account_id == $row->account_id){ }else{ echo 'disabled'; }   } ?>     ><?php echo $row->account_name; ?></option>
													<?php } ?>
												 </select>
											 </div>
										 </div>
								     ...
								     <div class="col-md-6"  >
										 <div class="form-group">
											 <div class="col-md-12">
												 <select class="form-control" name="to_account_id" <?php  if(!empty($from_account_list)){ echo 'required'; }  ?> disabled  >
													  <option value="">To Account</option>
													 <?php foreach($from_account_list as $row){ ?>
													 <option value="<?php echo $row->account_name; ?>" <?php if(isset($selected_money)){ if($selected_money[0]->to_account_id == $row->account_id){ echo 'selected'; }} ?> ><?php echo $row->account_name; ?></option>
													<?php } ?>
												 </select>
											 </div>
										 </div>
								      ...
								      <div class="col-md-6">
										<div class="form-group">
											<div class="col-md-12">
												<input type="number" step="0.01" class="form-control" name="amount" value="<?php echo $selected_money[0]->amount; ?>"  required><span class="placeholder">Amount</span>
											</div>
										</div>
								      </div> 
