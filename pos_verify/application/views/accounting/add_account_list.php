					...
					<section class="section_card">
						  <div class="panel-head" style="width:100%; height:30px; background-color:transparent; color:#dbd6d6; padding:10px 16px; ">
						      <h4 style="padding:0px; margin:0px; font-size:16px; text-transform:uppercase;">
										<i class="ion-android-radio-button-on" style="margin-right:10px;"></i> Add Account
									</h4>
						 </div>
						 <div class="panel-body" style="padding-left:0px; padding-right:0px;  background-color:#27293d; padding-top:15px; padding-bottom:0px;">
										<form class="form-horizontal form-bordered" action="<?php echo base_url(); ?>/account/add/" method="POST">
                                        <div class="col-md-12">
										
									  <div class="col-md-6">
										<div class="form-group">
											<div class="col-md-12">
												<input type="text" class="form-control" name="account_no" value=""  required><span class="placeholder">Account No</span>
											</div>
										</div>
								      </div> 
								      ...
								      <div class="col-md-6">
										<div class="form-group">
											<div class="col-md-12">
												<input type="text" class="form-control" name="account_name" value=""  required><span class="placeholder">Account Name</span>
											</div>
										</div>
								      </div> 
                                      ...
                                      <div class="col-md-6">
										<div class="form-group">
											<div class="col-md-12">
												<input type="number" step="0.01" class="form-control" name="initial_balance" value=""  required><span class="placeholder">Initial Balance</span>
											</div>
										</div>
								      </div>
								      ...
								      <div class="col-md-6">
										<div class="form-group">
											<div class="col-md-12">
												<input type="number" step="0.01" class="form-control" name="total_balance" value=""  required><span class="placeholder">Total Balance</span>
											</div>
										</div>
								      </div> 
                                      ...
                                      <div class="col-md-6">
											 <div class="form-group">
												 <div class="col-md-12">
                                                     <textarea class="form-control" name="note"  style="height:37px;"></textarea><span class="placeholder">Note</span>
												</div>
											</div>
						             </div>         
                                </div>
