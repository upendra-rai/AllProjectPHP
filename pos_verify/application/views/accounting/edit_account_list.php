						 ...
						 <div class="panel-body" style="padding-left:0px; padding-right:0px;  background-color:#27293d; padding-top:15px; padding-bottom:0px;">
									  ...
									  <div class="col-md-3">
										<div class="form-group">
											<div class="col-md-12">
												<input type="text" class="form-control" name="account_no" value="<?php echo $selected_list[0]->account_no; ?>"  required><span class="placeholder">Account No</span>
											</div>
										</div>
								      </div> 
								      ...
								      <div class="col-md-3">
										<div class="form-group">
											<div class="col-md-12">
												<input type="text" class="form-control" name="account_name" value="<?php echo $selected_list[0]->account_name; ?>"  required><span class="placeholder">Account Name</span>
											</div>
										</div>
								      </div> 
                                      ...
                                      <div class="col-md-3">
										<div class="form-group">
											<div class="col-md-12">
												<input type="text" class="form-control" name="initial_balance" value="<?php echo $selected_list[0]->initial_balance; ?>"  required><span class="placeholder">Initial Balance</span>
											</div>
										</div>
								      </div>
								      ...
								      <div class="col-md-3">
										<div class="form-group">
											<div class="col-md-12">
												<input type="text" class="form-control" name="total_balance" value="<?php echo $selected_list[0]->total_balance; ?>"  required><span class="placeholder">Total Balance</span>
											</div>
										</div>
								      </div> 
