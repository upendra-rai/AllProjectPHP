					...
					<section class="section_card">
						  <div class="panel-head" style="width:100%; height:30px; background-color:transparent; color:#dbd6d6; padding:10px 16px; ">
						      <h4 style="padding:0px; margin:0px; font-size:16px; text-transform:uppercase;">
										<i class="ion-android-radio-button-on" style="margin-right:10px;"></i> Edit Attendence
									</h4>
						 </div>
								...
								<form class="form-horizontal form-bordered" action="" method="POST">
									  ...
									  <div class="col-md-6">
										<div class="form-group">
											<div class="col-md-12">
												 <select class="form-control" name="employee_id" <?php  if(!empty($employee_lists)){ echo 'required'; }  ?>   >
													  <option value="">Employee Name</option>
													 <?php foreach($employee_lists as $row){ ?>
													 <option value="<?php echo $row->employee_id; ?>" <?php if(isset($selected_list)){ if($selected_list[0]->employee_id == $row->employee_id){ echo 'selected'; }} ?> ><?php echo $row->employee_name; ?></option>
													<?php } ?>
												 </select>
											</div>
										</div>
								      ...
								      <div class="col-md-6">
										<div class="form-group">
											<div class="col-md-12">
												<input type="date" class="form-control" name="date" value="<?php echo $selected_list[0]->date; ?>"  required><span class="placeholder">Date</span>
											</div>
										</div>
								      </div> 
                                      ...
                                      <div class="col-md-6">
										<div class="form-group">
											<div class="col-md-12">
												<input type="time"  class="form-control" name="checkin" value="<?php echo $selected_list[0]->checkin; ?>"  required><span class="placeholder">CheckIn</span>
											</div>
										</div>
								      </div>
								      ...
								      <div class="col-md-6">
										<div class="form-group">
											<div class="col-md-12">
												<input type="time"  class="form-control" name="checkout" value="<?php echo $selected_list[0]->checkout; ?>"  required><span class="placeholder">CheckOut</span>
											</div>
										</div>
								      </div>
								      ...
								      <div class="col-md-6">
										<div class="form-group">
											<div class="col-md-12">
												<input type="text"  class="form-control" name="note" value="<?php echo $selected_list[0]->note; ?>"  required><span class="placeholder">Note</span>
											</div>
										</div>
								      </div> 
