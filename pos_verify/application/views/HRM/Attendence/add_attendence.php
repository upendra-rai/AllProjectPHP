					...
					<section class="section_card">
						  <div class="panel-head" style="width:100%; height:30px; background-color:transparent; color:#dbd6d6; padding:10px 16px; ">
						      <h4 style="padding:0px; margin:0px; font-size:16px; text-transform:uppercase;">
										<i class="ion-android-radio-button-on" style="margin-right:10px;"></i> Add Attendence
									</h4>
						 </div>
						 <div class="panel-body" style="padding-left:0px; padding-right:0px;  background-color:#27293d; padding-top:15px; padding-bottom:0px;">
										<form class="form-horizontal form-bordered" action="<?php echo base_url(); ?>/department/add_attendence/" method="POST">
                                        <div class="col-md-12">
									  ...
									  <div class="col-md-6">
										<div class="form-group">
											...
											<select class="form-control" name="employee_id" required>
														 ...
														 <?php if(isset($employee1_list)){ foreach($employee1_list as $row){ ?>
								      ...
								      <div class="col-md-6">
										<div class="form-group">
											<div class="col-md-12">
												<input type="date" class="form-control" name="date" value=""  required><span class="placeholder">Date</span>
											</div>
										</div>
								      </div> 
                                      ...
                                      <div class="col-md-6">
										<div class="form-group">
											<div class="col-md-12">
												<input type="time"  class="form-control" name="checkin" value=""  required><span class="placeholder">CheckIn</span>
											</div>
										</div>
								      </div>
								      ...
								      <div class="col-md-6">
										<div class="form-group">
											<div class="col-md-12">
												<input type="time"  class="form-control" name="checkout" value=""  required><span class="placeholder">CheckOut</span>
											</div>
										</div>
								      </div>
