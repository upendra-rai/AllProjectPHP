					...
					<section class="section_card">
						  <div class="panel-head" style="width:100%; height:30px; background-color:transparent; color:#dbd6d6; padding:10px 16px; ">
						      <h4 style="padding:0px; margin:0px; font-size:16px; text-transform:uppercase;">
										<i class="ion-android-radio-button-on" style="margin-right:10px;"></i> Edit Payroll
									</h4>
						 </div>
						 <div class="panel-body" style="padding-left:0px; padding-right:0px;  background-color:#27293d; padding-top:15px; padding-bottom:0px;">
										...
										<div class="form-group">
											<div class="col-md-12">
												<select class="form-control" name="employee_id" required>
														 ...
														 <?php if(isset($employee_lists11)){ foreach($employee_lists11 as $row){ ?>
														 <option value="<?php echo $row->account_id; ?>"  
														 	<?php if(isset($selected_list11)){ if($selected_list11[0]->account_id == $row->account_id){ echo 'selected'; }} ?>
								      ...
								      <div class="col-md-6">
										<div class="form-group">
											<div class="col-md-12">
												<input type="text" class="form-control" name="account_id" value="<?php echo $selected_list11[0]->account_id; ?>"  required><span class="placeholder">Account</span>
											</div>
										</div>
								      </div> 
                                      ...
                                      <div class="col-md-6">
										<div class="form-group">
											<div class="col-md-12">
												<input type="text"  class="form-control" name="amount" value="<?php echo $selected_list11[0]->amount; ?>"  required><span class="placeholder">Amount</span>
											</div>
										</div>
								      </div>
								      ...
								      <div class="col-md-6">
										<div class="form-group">
											<div class="col-md-12">
												<input type="text"  class="form-control" name="paying_method" value="<?php echo $selected_list11[0]->paying_method; ?>"  required><span class="placeholder">Method</span>
											</div>
										</div>
								      </div>
								      ...
								      <div class="col-md-6">
										<div class="form-group">
											<div class="col-md-12">
												<input type="text"  class="form-control" name="note" value="<?php echo $selected_list11[0]->note; ?>"  required><span class="placeholder">Note</span>
											</div>
										</div>
								      </div> 
