					...
					<section class="section_card">
						  <div class="panel-head" style="width:100%; height:30px; background-color:transparent; color:#dbd6d6; padding:10px 16px; ">
						      <h4 style="padding:0px; margin:0px; font-size:16px; text-transform:uppercase;">
										<i class="ion-android-radio-button-on" style="margin-right:10px;"></i> Add Holiday
									</h4>
						 </div>
						 <div class="panel-body" style="padding-left:0px; padding-right:0px;  background-color:#27293d; padding-top:15px; padding-bottom:0px;">
										<form class="form-horizontal form-bordered" action="<?php echo base_url(); ?>/department/add_holiday/" method="POST">
                                        <div class="col-md-12">
										...
										<div class="form-group">
											<div class="col-md-12">
												<select class="form-control" name="user_id" required>
														 ...
														 <?php if(isset($holidays_list)){ foreach($holidays_list as $row){ ?>
								      ...
								      <div class="col-md-6">
										<div class="form-group">
											<div class="col-md-12">
												<input type="date" class="form-control" name="from_date" value=""  required><span class="placeholder">from Date</span>
											</div>
										</div>
								      </div> 
                                      ...
                                      <div class="col-md-6">
										<div class="form-group">
											<div class="col-md-12">
												<input type="date"  class="form-control" name="to_date" value=""  required><span class="placeholder">To Date</span>
											</div>
										</div>
								      </div>
								      ...
								      <div class="col-md-6">
										<div class="form-group">
											<div class="col-md-12">
												<input type="text"  class="form-control" name="note" value=""  required><span class="placeholder">Note</span>
											</div>
										</div>
								      </div>
...
<script type="text/javascript">
    $(document).ready(function(){
                          $('select[name=expanse_head]').change(function(){
                                    ...
                                    var user_id = $('select[name=account_name]').val();
                                    if(!user_id){
                                    	user_id = 0;
                                    }
                                    
                                    window.location.href = '<?php echo base_url(); ?>/department/add_holiday/'+user_id;
                         });
</script>
