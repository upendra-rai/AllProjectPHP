         ...
         <?php if($this->session->userdata('outlet_type') == 'restorent' || $this->session->userdata('user_role') == 'master admin'){ ?>   
          ...
          <li class="nav-parent <?php if(isset($active_menu)){ if($active_menu == 'report'){ echo 'nav-expanded nav-active'; } } ?>" name="report" >
            ...
            <ul class="nav nav-children">
              ...
              <li class="<?php if(isset($active_submenu)){ if($active_submenu == 'product_sale_report'){ echo 'nav-active'; } } ?>">
                <a href="<?php echo base_url(); ?>report/product_sale">
                  Product Sale Report
                </a>
              </li>
               <li class="<?php if(isset($active_submenu)){ if($active_submenu == 'sale_report'){ echo 'nav-active'; } } ?>">
                <a href="<?php echo base_url(); ?>report/sale_report">
                    Sale Report
                </a>
              </li>
              <li class="<?php if(isset($active_submenu)){ if($active_submenu == 'summery_report'){ echo 'nav-active'; } } ?>">
                <a href="<?php echo base_url(); ?>report/summery_report">
                    Summery Report
                </a>
              </li>
            </ul>
            ...
            <ul class="nav nav-children">
             ...
             <li class="nav-parent <?php if(isset($active_menu)){ if($active_menu == 'setting'){ echo 'nav-expanded nav-active'; } } ?>" name="setting" >
            <a>
              <i class="fa fa-columns" aria-hidden="true"></i>
              <span>Setting</span>
            </a>
            ...
            <ul class="nav nav-children">
               ...
               <li class="<?php if(isset($active_submenu)){ if($active_submenu == 'smsaccount'){ echo 'nav-active'; } } ?>">
                <a href="<?php echo base_url(); ?>setting/smsaccount">
                    SMS Account
                </a>
              </li>
              <li class="<?php if(isset($active_submenu)){ if($active_submenu == 'payment_setting'){ echo 'nav-active'; } } ?>">
                <a href="<?php echo base_url(); ?>setting/payment_setting">
                    Payment Setting
                </a>
              </li>
              <li class="<?php if(isset($active_submenu)){ if($active_submenu == 'add_payment'){ echo 'nav-active'; } } ?>">
                <a href="<?php echo base_url(); ?>setting/add_payment">
                    Add Payment API
                </a>
              </li>
              <li class="<?php if(isset($active_submenu)){ if($active_submenu == 'upi_details'){ echo 'nav-active'; } } ?>">
                <a href="<?php echo base_url(); ?>setting/upi_details">
                    Add UPI Details
                </a>
              </li>
