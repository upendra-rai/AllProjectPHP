  ...
  <div class="header-right">
      <div class="col-md-6">
        <p style="color: #ffffff; font-size: 20px;  line-height: 55px; text-transform: uppercase; letter-spacing: 1px;
                  padding-left: 0px;">Food Delivery Menagement System  <a href="http://localhost/electron/home.html" target="_blank"><button type="button" class="btn">POS</button></a></p>
    ...
    <ul class="notifications">
      ...
      <li>
        <a href="#" class="dropdown-toggle notification-icon" data-toggle="dropdown">
          ...
          <span class="badge new_order_span"></span>
        </a>
