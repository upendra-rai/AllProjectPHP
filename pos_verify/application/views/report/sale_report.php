...
<body>
                   ...
                   <div class="col-md-2" style="padding:6px;">
                     <div class="form-group">
                          <select class="form-control" name="outlet_name">
                             ...
                             <?php if(isset($sale_list)){ foreach($sale_list as $row){ ?>
                    ...
                    <div class="col-md-2" style="padding:6px;">
                     <div class="form-group">
                          <select class="form-control" name="user_name">
                             ...
                             <?php if(isset($sale_list1)){ foreach($sale_list1 as $row){ ?>
                             <option value="<?php echo $row->staff_id; ?>"  ><?php echo $row->user_name; ?></option>
                             <?php }}  ?>
                         </select> 
                     </div>
                    </div>
								 ...
								 <header class="panel-heading" style="padding:0px 15px;">
								     	<div class="heading_box" style=" border-bottom: none; padding: 6px 2px; height:36px; background-color:#27293d;">
									        <h2 class="panel-title" style="color:#dbd6d6; font-size:16px; line-height:10px; text-transform:uppercase;">
														...
														Sale Report <i class="ion-chevron-right" style="padding:0px 10px; color:#0088cc;"></i> <?php if(isset($return_date)){ echo date('d-M-Y',strtotime($return_date)); } ?>
													</h2>
									    </div>
								</header>
     ...
     <tbody id="customer_table">
                      <?php $i = 1; if(isset($list)){ $sum_amount = 0; foreach($list as $row){ ?>
                         ...
                         <td><?php echo $i++; ?></td>
                         <td><?php echo date("d-M-Y", strtotime($row->row_date));; ?></td>
                         ...
                         <td><?php if($row->sale_status == 1){echo 'paid';} elseif  ($row->sale_status == 2){echo 'Draft';} ?></td> 
