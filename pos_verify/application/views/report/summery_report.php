      ...
      <?php $this->load->view("common/titlebar"); ?>
								 ...
								 <header class="panel-heading" style="padding:0px 15px;">
								     	<div class="heading_box" style=" border-bottom: none; padding: 6px 2px; height:36px; background-color:#27293d;">
									        <h2 class="panel-title" style="color:#dbd6d6; font-size:16px; line-height:10px; text-transform:uppercase;">
														...
														Summery Report <i class="ion-chevron-right" style="padding:0px 10px; color:#0088cc;"></i> <?php if(isset($return_date)){ echo date('d-M-Y',strtotime($return_date)); } ?>
													</h2>
									    </div>
								</header>
            ...
            <div class="row">
                ...
                <div style="border: 1px solid grey; padding: 15px;">
                   <h4>Purchase</h4>
                  <p>Amount<span style= "float: right;"> <?php echo $summery_details[0]->total_cost;
                       ?></span></p>
                   <p>Purchase<span style= "float: right;"> <?php echo $summery_details[0]->total_cost;
                       ?></span></p>
                    <p>Paid<span style= "float: right;"><?php echo $summery_details[0]->paid_amount;
                       ?></span></p>
                     <p>Tax<span style= "float: right;"><?php echo $summery_details[0]->total_tax;
                       ?></span></p>
                 </div>
               </div>
               <div class="col-md-3"  style=" color:white; padding: 15px;">
                <div style="border: 1px solid grey; padding: 15px;">
                   <h4>Sale</h4>
                   <p>Amount<span style= "float: right;"><?php echo $sale_details[0]->total_price;
                       ?></span></p>
                   <p>Purchase<span style= "float: right;"> 400.00</span></p>
                    <p>Paid<span style= "float: right;"> 400.00</span></p>
                     <p>Tax<span style= "float: right;"> 400.00</span></p>
                 </div>
               </div>
               <div class="col-md-3"  style=" color:white; padding: 15px;">
                <div style="border: 1px solid grey; padding: 15px;">
                   <h4>Sale Return</h4>
                   <p>Amount<span style= "float: right;"> 50.00</span></p>
                   <p>Purchase<span style= "float: right;"> 400.00</span></p>
                    <p>Paid<span style= "float: right;"> 400.00</span></p>
                     <p>Tax<span style= "float: right;"> 400.00</span></p>
                 </div>
