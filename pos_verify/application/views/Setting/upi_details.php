				...
				<header class="panel-heading" style="padding:0px 15px;">				     	<div class="heading_box" style=" border-bottom: none; padding: 6px 2px; height:36px; background-color:#27293d;">
						<h2 class="panel-title" style="color:#dbd6d6; font-size:16px; line-height:10px; text-transform:uppercase;">
							<i class="ion-android-radio-button-on" style="margin-right:10px;"></i>
							 Add UPI Details <i class="ion-chevron-right" style="padding:0px 10px; color:#0088cc;"></i> <?php if(isset($return_date)){ echo date('d-M-Y',strtotime($return_date)); } ?>
							</h2>
        				    </div>
								</header>
            ...
            <div class="container">
               ...
               <div class="col-md-3"  style=" color:white; padding: 15px; width: 500px;">
                <div style="border: 1px solid grey; padding: 15px;">
                   <h4>PA <span style= "float: right;">
                    <input type="text" class="form-control" name="pa" value="<?php echo $list[0]->pa ?>"  >
                        </span></h4>
                 </div>         
               </div>
            </div>
               ...
               <div class="col-md-3"  style=" color:white; padding: 15px; width: 500px;">
                <div style="border: 1px solid grey; padding: 15px;">
                   <h4>PN <span style= "float: right;">
                    <input type="text" class="form-control" name="pn" value="<?php echo $list[0]->pn ?>"  required>
                        </span></h4>
                 </div>         
               </div>
            </div>
               ...
               <div class="col-md-3"  style=" color:white; padding: 15px; width: 500px;">
                <div style="border: 1px solid grey; padding: 15px;">
                   <h4>MC <span style= "float: right;">
                    <input type="text" class="form-control" name="mc" value="<?php echo $list[0]->mc ?>"  required>
                        </span></h4>
                 </div>         
               </div>
            </div>
               ...
               <div class="col-md-3"  style=" color:white; padding: 15px; width: 500px;">
                <div style="border: 1px solid grey; padding: 15px;">
                   <h4>URL <span style= "float: right;">
                    <input type="text" class="form-control" name="url" value="<?php echo $list[0]->url ?>"  required>
                        </span></h4>
                 </div>         
               </div>
            </div>
