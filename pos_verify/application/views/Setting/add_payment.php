				...
				<header class="panel-heading" style="padding:0px 15px;">				     	<div class="heading_box" style=" border-bottom: none; padding: 6px 2px; height:36px; background-color:#27293d;">
						<h2 class="panel-title" style="color:#dbd6d6; font-size:16px; line-height:10px; text-transform:uppercase;">
							<i class="ion-android-radio-button-on" style="margin-right:10px;"></i>
							 Add Payment API <i class="ion-chevron-right" style="padding:0px 10px; color:#0088cc;"></i> <?php if(isset($return_date)){ echo date('d-M-Y',strtotime($return_date)); } ?>
							</h2>
        				    </div>
								</header>
            ...
            <div class="container">
               ...
               <div class="col-md-3"  style=" color:white; padding: 15px; width: 500px;">
                <div style="border: 1px solid grey; padding: 15px;">
                   <h4>Payment API Key <span style= "float: right;">
                    <input type="text" class="form-control" name="payment_id" value="<?php echo $list[0]->payment_id ?>"  >
                        </span></h4>
                 </div>         
               </div>
            </div>
               ...
               <div class="col-md-3"  style=" color:white; padding: 15px; width: 500px;">
                <div style="border: 1px solid grey; padding: 15px;">
                   <h4>Gateway Color <span style= "float: right;">
                    <input type="text" class="form-control" name="theme_color" value="<?php echo $list[0]->theme_color?>"  required>
                        </span></h4>
                 </div>         
               </div>
            </div>
