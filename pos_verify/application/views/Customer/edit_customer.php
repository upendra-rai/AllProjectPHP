					...
					<section class="section_card">
						  <div class="panel-head" style="width:100%; height:30px; background-color:transparent; color:#dbd6d6; padding:10px 16px; ">
						      <h4 style="padding:0px; margin:0px; font-size:16px; text-transform:uppercase;">
										<i class="ion-android-radio-button-on" style="margin-right:10px;"></i> Edit Account
									</h4>
						 </div>
						 <div class="panel-body" style="padding-left:0px; padding-right:0px;  background-color:#27293d; padding-top:15px; padding-bottom:0px;">
								      ...
								      <div class="col-md-6">
										<div class="form-group">
											<div class="col-md-12">
												<input type="text" class="form-control" name="name" value="<?php echo $selected_list[0]->name; ?>"  required><span class="placeholder">Name</span>
											</div>
										</div>
								      </div> 
								      ...
								      <div class="col-md-6">
										<div class="form-group">
											<div class="col-md-12">
												<input type="text" class="form-control" name="company_name" value="<?php echo $selected_list[0]->company_name; ?>"  required><span class="placeholder">Company Name</span>
											</div>
										</div>
								      </div> 
                                      ...
                                      <div class="col-md-6">
										<div class="form-group">
											<div class="col-md-12">
												<input type="text"  class="form-control" name="email" value="<?php echo $selected_list[0]->email; ?>"  required><span class="placeholder">Email</span>
											</div>
										</div>
								      </div>
								      ...
								      <div class="col-md-6">
										<div class="form-group">
											<div class="col-md-12">
												<input type="text"  class="form-control" name="phone_number" value="<?php echo $selected_list[0]->phone_number; ?>"  required><span class="placeholder">Phone Number</span>
											</div>
										</div>
								      </div>
								      ...
								      <div class="col-md-6">
										<div class="form-group">
											<div class="col-md-12">
												<input type="number"  class="form-control" name="tax_no" value="<?php echo $selected_list[0]->tax_no; ?>"  required><span class="placeholder">Tax Number</span>
											</div>
										</div>
								      </div> 
								      <div class="col-md-6">
										<div class="form-group">
											<div class="col-md-12">
												<input type="text"  class="form-control" name="address" value="<?php echo $selected_list[0]->address; ?>"  required><span class="placeholder">Address</span>
											</div>
										</div>
								      </div> 
								      <div class="col-md-6">
										<div class="form-group">
											<div class="col-md-12">
												<input type="text"  class="form-control" name="city" value="<?php echo $selected_list[0]->city; ?>"  required><span class="placeholder">City</span>
											</div>
										</div>
								      </div> 
								      <div class="col-md-6">
										<div class="form-group">
											<div class="col-md-12">
												<input type="number"  class="form-control" name="deposit" value="<?php echo $selected_list[0]->deposit; ?>"  required><span class="placeholder">Balance</span>
											</div>
										</div>
								      </div> 
