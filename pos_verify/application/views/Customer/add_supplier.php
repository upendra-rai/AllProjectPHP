				...
				<section role="main" class="content-body" >
					...
					<section class="section_card">
						 ...
						 <div class="panel-body" style="padding-left:0px; padding-right:0px;  background-color:#27293d; padding-top:15px; padding-bottom:0px;">
										<form class="form-horizontal form-bordered" action="<?php echo base_url(); ?>/customer/add_supplier/" method="POST">
                                        <div class="col-md-12">
										
									  <div class="col-md-6">
										<div class="form-group">
											<div class="col-md-12">
												<input type="text" class="form-control" name="supplier_name" value=""  required><span class="placeholder">Supplier Name</span>
											</div>
										</div>
								      </div> 
								      ...
								      <div class="col-md-6">
										<div class="form-group">
											<div class="col-md-12">
												<input type="text" class="form-control" name="supplier_mobile_no" value=""  required><span class="placeholder">Mobile Number</span>
											</div>
										</div>
								      </div> 
                                      ...
                                      <div class="col-md-6">
										<div class="form-group">
											<div class="col-md-12">
												<input type="text"  class="form-control" name="supplier_email_id" value=""  required><span class="placeholder">Email</span>
											</div>
										</div>
								      </div>
								      ...
								      <div class="col-md-6">
										<div class="form-group">
											<div class="col-md-12">
												<input type="text"  class="form-control" name="supplier_address" value=""  required><span class="placeholder">Address</span>
											</div>
										</div>
								      </div>        
