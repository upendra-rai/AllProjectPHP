                      ...
                      <?php $i = 1; if(isset($list)){ foreach($list as $row){ ?>
                       ...
                       <a href=""> <tr>
                         ...
                         <td><?php echo $i++; ?></td>
                          ...
                          <td class="due_amount"><?php if($row->grand_total - $row->paid_amount > 0){ echo $row->grand_total - $row->paid_amount; }else{ echo '0'; } ?></td>     
                          <td><?php if($row->payment_status == 0){ echo  'Due'; }else if($row->payment_status == 1){ echo 'Paid'; } ?></td> 
                          
                           <td style="padding:2px 5px;">
                               <div class="">
                               <select class="form-control" name="drop_action" style="width:100px; height:25px ; padding:2px;"  data-id="<?php echo $row->purchase_id; ?>">          <option style="width:200px;">Action</option>
                                   <option value="view">View</option>
                                   <option value="edit">Edit</option>
                                   <option value="add_payment">Add Payment &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp</option>
                                   <option value="view_payment">View Payment &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp</option><option value="delete">Delete</option>
                               </select>
                               </div>
                           </td>
                         </tr>
...
<script type="text/javascript">
     ...
     // set scroll position
            ...
            $(document).on('change','select[name=drop_action]',function(){ 
                ...
                alert(val);
                if(val === 'view'){
                    var src = '<?php echo base_url(); ?>/inventory/purchase_invoice/'+id;
