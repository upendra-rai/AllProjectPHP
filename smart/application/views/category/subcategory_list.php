                ...
                <section role="main" class="content-body" >
						...
						<section class="section_card" id="table_section">
                          ...
                          <tr>
                                ...
                                <td>
                                    <a 
                                       href="<?php echo base_url(); ?>/management/edit_subcategory/<?php echo $row->sub_category_id; ?>"> <button type="button"   style=" width:100%;"><i class="fa fa-pencil"></i></button>

                                   </a>
                                 </td>
                      

                                <td style="text-align:center;"><button type="button" class="btn btn-primary" id="confirm_del_action" data-confirm_del_id="<?php echo $row->sub_category_id; ?>" style="color:#ff4747; "><i class="fa  fa-times-circle"></i></button></td>
                          </tr>
										<?php }} ?>
									</tbody>
								</table>
						...
						<section class="section_card" id="table_section">
										...
										<div class="form-group">
											<div class="col-md-12">
                                                <select class="form-control" name="category_id"   >
													 ...
													 <option value="<?php echo $row->category_id; ?>" <?php if(isset($selected_subcategory)){  if($selected_subcategory[0]->category_id == $row->category_id){echo 'selected';  }else{ echo ''; }   } ?>     ><?php echo $row->category_name; ?></option>
													<?php } ?>
												 </select>
											</div>
										</div>
                                    ...
                                    <div class="col-md-12" >
										<div class="form-group">
											<div class="col-md-12">
												<input type="text" class="form-control" name="sub_category_desc" value="<?php if(isset($selected_subcategory[0])){ echo $selected_subcategory[0]->sub_category_desc; } ?>" ><span class="placeholder">Description</span>
											</div>
										</div>
								     </div> 
									...
									<div class="col-md-6">
											<div class="form-group">
												<div class="col-md-12">
												<a href="<?php echo base_url(); ?>management/manage_subcategory">	<button type="button" class="btn-transparent btn-red"  style="  width:100%; height:35px;">Cancel</button></a>
												</div>
											</div>
										</div>
						             </div>
 ...
 $(document).on('click','button[id=confirm_del_action]',function(){
		...
		$(document).on('click','button[id=del_bt]',function(){
			   var del_id = $(this).data("del_id");
							$.ajax({
		              url : '<?php echo base_url(); ?>/management/delete_subcategory',
								  method: 'POST',
									data:{del_id: del_id},
