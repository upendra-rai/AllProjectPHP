                                        ...
                                        <form action=""  method="post" >
                                           <div class="col-lg-10 col-md-10 col-sm-12 col-xs-12" >
                                               ...
                                               <div class="form-group" id="data_5" style=" height:28px;">
                                                ...
                                                <div class="form-group" id="data_5" style=" height:28px;">
                                                    <select class="form-control" name="promo_code" required>
                                                        <option value="">Select Promo Code</option>
                                                        
                                                        <?php foreach($promo_list as $row){ ?>
                                                        <option value="<?php echo $row->promo_id; ?>">[ <?php echo $row->promo_code; ?> ]  <?php echo $row->promo_detail; ?></option>
                                                        <?php } ?>
                                                    </select>    
                                                </div>
                                        ...
                                        <form action=""  method="post" id="myformsearch">
                                           <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12" >   
                                                <div class="form-group" id="data_5" style=" height:28px;">
                                                   ...
                                                   <input type="text" name="name_search" id="name_search" value="<?php if(isset($return_name)){ echo $return_name; } ?>" class="form-control" placeholder="Search By Customer Name" style="width:100%;">
                                                </div>
                                           </div>
                                             ...
                                             <div class="col-lg-2 col-md-2 col-sm-2 col-xs-12" >
                                                  <div class="form-group" id="data_5" style=" height:28px;">
                                                       <span class="search_input_i"><i class="fa fa-search"></i></span>
                                                     <input type="text" name="mobile_no" id="mobile_no" value="<?php if(isset($return_mobile_no)){ echo $return_mobile_no; } ?>" class="form-control" placeholder="Search By Mobile No." style=" width:100%;">
                                                  </div>
                                           </div>
                                             <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12" >   
                                                <div class="form-group" id="data_5" style=" height:28px;">
                                                     <span class="search_input_i"><i class="fa fa-search"></i></span>
                                                   <input type="email" name="email_search" id="email_search" value="<?php if(isset($return_email)){ echo $return_email; } ?>" class="form-control" placeholder="Search By Customer Name" style="width:100%;">
                                                </div>
                                           </div>
