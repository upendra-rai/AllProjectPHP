					...
					<section class="section_card">
						...
						<section class="section_card" id="table_section">
							  ...
							  <div class="panel-body " style="padding-top:0px;">
								   <table class="table mb-none" id="table1" data-toggle="table1" data-pagination="true1" style="border-bottom: 1px solid #424351;">
                                   <form method="post" enctype="multipart/form-data">
                                        
                                   
                                                        <div style="position:static; left:40px; right:40px;" >
                                                        <span>Please Upload Only CSV File</span> <input type="file" name="file" size="150"  class="form-control" required><br>
											...
											<a href="download" style="float:left;"><button type="button" class="btn-transparent btn-green"  style=" width:100%; padding:10px 15px; margin-top:-8px;">Download</button></a>
                                              </div>
