...
//############## home  ###############//**************//  	
 //##############****************###############//**************// 	
  	public function index(){
  		  //$this->load->model_assign();
          $data['product_details'] = $this->model_assign->getAllProducts();
  		 $this->load->view('test',$data);
  	}
public function plans(){
     $data['plans_details'] = $this->model_assign->plans_details();
  		 $this->load->view('plans',$data);
}

      public function classes(){
          
          $data['classes_details'] = $this->model_assign->classes_details();
  		 $this->load->view('classes',$data);
      }
      public function delete_details(){
  		  		 $id = $this->uri->segment(3);
               $this ->model_assign->delete_details($id);
