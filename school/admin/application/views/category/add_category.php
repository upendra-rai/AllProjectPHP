			...
			<div class="inner-wrapper">
			  <?php $this->load->view('common/sidemenu'); ?>
				...
				<section role="main" class="content-body" >
				  ...
				  <td>
                    <a 
                       href="<?php echo base_url(); ?>/master/edit_category/<?php echo $row->my_category_id; ?>"> <button type="button"   style=" width:100%;"><i class="fa fa-pencil"></i></button>
                                ...
                                <div class="container-fluid">
                                   ...
                                   <div class="col-md-6">
                                    ...
                                    <div class="col-md-12">
										  <div class="form-group">
											   <div class="col-md-12">
												 ...
												 <label for="file" id="img_label" style="width:150px; height:150px; border:1px solid #424351; text-align:center;  font-size:25px;"><?php if(isset($selected_category[0])){ ?> <img src="<?php echo base_url(); ?>uploads/category_img/<?php echo $selected_category[0]->category_img; ?>" data-img_name="" alt="" style="width:100% ; height:100%;"/><input type="hidden" name="category_img" value="<?php echo $selected_category[0]->category_img; ?>" /><button type="button" class="btn" id="temprory_remove_image" style="position:absolute; background-color:#ff4747; color:#ffffff; margin-top:-2px;">X</button>  <?php }else{ ?> <i class="fa fa-globe" style="margin-top:60px; margin-right:5px;"></i><span style="font-size:12px; ">Browse</span> <?php  } ?>  </label>
											   </div>
									...
									<div class="col-md-6">
											<div class="form-group">
												<div class="col-md-12">
												<a href="<?php echo base_url(); ?>master/manage_category">	<button type="button" class="btn-transparent btn-red"  style="  width:100%; height:35px;">Cancel</button></a>
												</div>
											</div>
										</div>
						             </div>
