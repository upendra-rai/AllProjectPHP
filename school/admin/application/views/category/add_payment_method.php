						...
						<section class="section_card" id="table_section">
									...
									<div class="col-md-6">
										<div class="form-group">
											<div class="col-md-12">
												<input type="text" class="form-control" name="payment_method_name" value="<?php if(isset($selected_payment_method[0])){ echo $selected_payment_method[0]->payment_method_name; } ?>"  required><span class="placeholder"> Payment Method Name</span>
											</div>
										</div>
								     </div>
