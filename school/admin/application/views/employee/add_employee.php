						...
						<section class="section_card" id="table_section">
									...
									<div class="col-md-6">
										<div class="form-group">
											<div class="col-md-12">
												<input type="text" class="form-control" name="employee_login_id" value="<?php if(isset($selected_employee[0])){ echo $selected_employee[0]->employee_login_id; } ?>"  required><span class="placeholder">Login ID</span>
											</div>
										</div>
								     </div>
                                   ...
                                   <div class="col-md-6">
										<div class="form-group">
											<div class="col-md-12">
												<input type="text" class="form-control" name="employee_password" value="<?php if(isset($selected_employee[0])){ echo $selected_employee[0]->employee_password; } ?>"  required><span class="placeholder"> Password</span>
											</div>
										</div>
								     </div>
                                <div class="col-md-6">
										<div class="form-group">
											<div class="col-md-12">
												<input type="text" class="form-control" name="employee_first_name" value="<?php if(isset($selected_employee[0])){ echo $selected_employee[0]->employee_first_name; } ?>"  required><span class="placeholder"> Employee First Name</span>
											</div>
										</div>
								     </div>
                                    <div class="col-md-6">
										<div class="form-group">
											<div class="col-md-12">
												<input type="text" class="form-control" name="employee_last_name" value="<?php if(isset($selected_employee[0])){ echo $selected_employee[0]->employee_last_name; } ?>"  required><span class="placeholder"> Employee Last Name</span>
											</div>
										</div>
								     </div>
                                            <div class="col-md-6">
										<div class="form-group">
											<div class="col-md-12">
												<input type="number" class="form-control" name="employee_contact_number" value="<?php if(isset($selected_employee[0])){ echo $selected_employee[0]->employee_contact_number; } ?>"  required><span class="placeholder"> Employee Contact</span>
											</div>
										</div>
								     </div>
                                    <div class="col-md-6">
										<div class="form-group">
											<div class="col-md-12">
												<input type="email" class="form-control" name="employee_email_id" value="<?php if(isset($selected_employee[0])){ echo $selected_employee[0]->employee_email_id; } ?>"  required><span class="placeholder"> Employee Email Id</span>
											</div>
										</div>
								     </div>
                                             <div class="col-md-6">
										<div class="form-group">
											<div class="col-md-12">
                                                <select class="form-control" name="employee_profile"   >
													  <option value="">Employee Profile</option>
													 <?php foreach($employee_profile_list as $row){ ?>
													 <option value="<?php echo $row->profile_type_id; ?>" <?php if(isset($selected_employee)){  if($selected_employee[0]->profile_type_id == $row->profile_type_id){echo 'selected';  }else{ echo ''; }   } ?>     ><?php echo $row->profile_type_name; ?></option>
													<?php } ?>
												 </select>
									...
									<div class="col-md-2">
											<div class="form-group">
												<div class="col-md-12">
												<a href="<?php echo base_url(); ?>master/employee_details">	<button type="button" class="btn-transparent btn-red"  style=" width:100%;">Cancel</button></a>
												</div>
											</div>
										</div>
						             </div>
