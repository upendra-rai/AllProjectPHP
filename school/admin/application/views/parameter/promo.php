								 ...
								 <header class="panel-heading" style="padding:0px 15px;">
								     	<div class="heading_box" style=" border-bottom: none; padding: 6px 2px; height:36px; background-color:#27293d;">
									        <h2 class="panel-title" style="color:#dbd6d6; font-size:16px; line-height:10px; text-transform:uppercase;">
														...
														Promo Code  List <i class="ion-chevron-right" style="padding:0px 10px; color:#0088cc;"></i> 
														
														
														<a href="<?Php echo base_url(); ?>discount/add"><button type="btn" class="btn-transparent btn-green" style="position:absolute; right:12px; top:8px; width:80px; height:25px; border:1px solid #e2e2e2;">+ Add </button></a>
													</h2>
									    </div>
								</header>
										...
										<tbody>
										  <?php $i = 1; foreach($list as $row){ ?>
                                                  <tr>
														  ...
														  <td style=" text-align:center;"><a href="<?php echo base_url(); ?>discount/edit/<?php echo $row->promo_id; ?>"><button class="btn btn-primary" id=""  data-edit_id="" style="color:#248afd; background-color:#f2f2f2; border:1px solid #e2e2e2;"><i class="fa fa-pencil"></i></button></a></td>
