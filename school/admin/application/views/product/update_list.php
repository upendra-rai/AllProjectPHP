						...
						<section class="section_card" id="table_section">
									...
									<div class="col-md-6">
										<div class="form-group">
											<div class="col-md-12">
												<input type="text" class="form-control" name="product_type_name" value="<?php if(isset($selected_product[0])){ echo $selected_product[0]->product_type_name; } ?>"  required><span class="placeholder"> Product Type Name</span>
											</div>
										</div>
								     </div>
									...
									<div class="col-md-2">
											<div class="form-group">
												<div class="col-md-12">
												<a href="<?php echo base_url(); ?>management/product_details">	<button type="button" class="btn-transparent btn-red"  style=" width:100%;">Cancel</button></a>
												</div>
											</div>
										</div>
						             </div>
