...
<header class="header" style="background:#1e1e2f; border:none; border-bottom: 1px solid #424351;">
  <div class="logo-container">
    <a href="" class="logo">
      <img src="<?php echo base_url(); ?>/catalogs/assets/images/logo.png" height="40" alt="JSOFT Admin" style="margin-left:10px;"/>
       <span class="role" style="color:#ffffff;">Numbers Atm</span>
    </a>
  ...
  <div class="header-right">
      <div class="col-md-6">
        <p style="color: #ffffff; font-size: 20px;  line-height: 55px; text-transform: uppercase; letter-spacing: 1px;
                  padding-left: 0px;">Numbers Atm <a href="http://localhost/electron/home.html" target="_blank"><button type="button" class="btn">POS</button></a></p>
  <!--   <ul class="quick_report">
    ...
    <?php } ?>  
      ...
      <div id="userbox" class="userbox" style="ont-weight:700; background-color:<?php if($this->session->userdata('user_role') == 'admin'){ echo '#ff4748'; }else if($this->session->userdata('user_role') == 'admin'){ echo '#673ab7'; }else if($this->session->userdata('user_role') == 'sub admin'){ echo '#b5f43e'; } ?>; color:#ffffff; padding:5px 5px; border-radius:30px; width: 160px; text-align:center; float:right; margin-top:10px;">
      <a href="#" data-toggle="dropdown">
        
        <div class="profile-info">
          <!--<span class="name" style="font-size:10px;"><?php echo $this->session->userdata('user_name'); ?></span>-->
          <span class="role" style="font-size:14px; font-weight:700; text-transform:capitalize;">Admin</span>
        </div>
