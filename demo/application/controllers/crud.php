...
//############## search bar  ###############//**************//  	
 //##############****************###############//**************// 			  	
         ...
         public function search_bar1(){
          $quantity=$this->input->post("search_bar1");
          // echo "hiii";
            $data["product_details"]=$this->crud_model->search_bar1($quantity);
             $this->load->view('crud_view',$data);
         }
            public function search_bar2(){
          $price=$this->input->post("search_bar2");
          //echo $price;
           $data["product_details"]=$this->crud_model->search_bar2($price);
           $this->load->view('crud_view',$data);
          // print_r($data);
