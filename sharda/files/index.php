...
<body>
    ...
    <div class="swiper-wrapper">
      <div class="swiper-slide"><img src="image/home.png">
        <div class="slider_content">
          ...
          <p style="font-size:30px;">grab your <br><b>VIP NUMBER</b> now</p>
      ...
      <div class="swiper-slide"><img src="image/home.png"> <div class="slider_content">
      ...
      <div class="swiper-slide"><img src="image/home.png"></div>
    ...
    <section class="company_logo">
        ...
        <img src="image/bsnl.PNG" alt="">
        <img src="image/mtnl.PNG" alt="">
        <img src="image/vodafone.PNG" alt="">
        </div>
    </section>
     <!--process section -->
     <!--process  section -->
     ...
     <!--process section -->
        ...
        <div class="col-md-6" style="">
            <div class="col-md-2 col-xs-2" style="padding-right: 0px;">
                <div class="img_box"> <img src="image/step1.png" alt=""></div>
           <div class="img_box">
  ...
  Your browser does not support the video tag.
            ...
            <div class="col-md-4">
                ...
                <div class="col-md-8">
                    ...
                    <div class="col-md-12" style="padding: 0px 120px;">
                        ...
                        <div class="app">
                         <div class="img2">                      
                         <img src="image/justdial.PNG" alt="">
                         </div>
                            <div class="i_tag" >      
                                    <i class="fa fa-star"></i>
                                    <i class="fa fa-star"></i>
                ...
                <div class="col-md-3">
                        <div class="app">
                         <div class="img2">                      
                         <img src="image/trustpilot.PNG" alt="">
                         </div>
                            <div class="i_tag" >      
                                    <i class="fa fa-star"></i>
                                    <i class="fa fa-star"></i>
    ...
    <div class="swiper-wrapper">
      <div class="swiper-slide"> <img src="image/img1.png" alt=""></div>
      <div class="swiper-slide"><img src="image/img2.png" alt=""></div>
      <div class="swiper-slide"><img src="image/img3.png" alt=""></div>
      <div class="swiper-slide"><img src="image/img4.png" alt=""></div>
