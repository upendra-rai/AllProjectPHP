          ...
          <li class="nav-parent <?php if(isset($active_menu)){ if($active_menu == 'master'){ echo 'nav-expanded nav-active'; } } ?>" name="master">
            ...
            <ul class="nav nav-children">
              <li class="<?php if(isset($active_submenu)){ if($active_submenu == 'product_details'){ echo 'nav-active'; } } ?>">
                <a href="<?php echo base_url(); ?>master/product_details">
                   Product
                </a>
              </li>
                
                <li class="<?php if(isset($active_submenu)){ if($active_submenu == 'projects_details'){ echo 'nav-active'; } } ?>">
                <a href="<?php echo base_url(); ?>master/projects_details">
                   Project
                </a>
              </li>
                <li class="<?php if(isset($active_submenu)){ if($active_submenu == 'source_details'){ echo 'nav-active'; } } ?>">
                <a href="<?php echo base_url(); ?>master/source_details">
                   Source
                </a>
              </li>
                <li class="<?php if(isset($active_submenu)){ if($active_submenu == 'status_details'){ echo 'nav-active'; } } ?>">
                <a href="<?php echo base_url(); ?>master/status_details">
                   Lead Status
                </a>
              </li>
            </ul>
...
-->
            <li class="">
            <a href="<?php echo base_url(); ?>main_profile/main_profile_detail">
              <i class="fa fa-home" aria-hidden="true"></i>
