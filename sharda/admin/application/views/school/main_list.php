                 ...
                 <header class="panel-heading" style="padding:0px 15px;">
                      ...
                      <div class="heading_box" style=" border-bottom: none; padding: 6px 2px; height:36px; background-color:#27293d;">
                          ...
                          <h2 class="panel-title" style="color:#dbd6d6; font-size:16px; line-height:10px; text-transform:uppercase;">
                            ...
                            Profile List <i class="ion-chevron-right" style="padding:0px 10px; color:#0088cc;"></i> 
                            <a href="<?php echo base_url(); ?>main_profile/add"type="btn" class="btn-transparent btn-green" style="position:absolute; right:12px; top:8px;">Add Profile</a>
                          </h2>
                      </div>
                </header>
                  ...
                  <tbody>
                      ...
                      <?php  $i = 1; if(isset($profile_details)) {foreach($profile_details as $row) {?>
                          <tr>
                              ...
                              <td><?php echo $i++;  ?></td>                              
                              <td style="width:110px; padding:4px; text-align:center;"><img src="<?php echo base_url(); ?>uploads/profile_image/<?php echo $row->profile_image; ?>" style="border-radius:2px; border:1px solid #45496d;" width="100" ></td>
                              

                    <td>
                    <a 
                       href="<?php echo base_url(); ?>/main_profile/edit/<?php echo $row->profile_id; ?>"> <button type="button"   style=" width:100%;"><i class="fa fa-pencil"></i></button>
                   </a>
                      </td>
                      

                              <td style="text-align:center;"><button type="button" class="btn btn-primary" id="confirm_del_action" data-confirm_del_id="<?php echo $row->profile_id; ?>" style="color:#ff4747; "><i class="fa  fa-times-circle"></i></button>
                              </td>
                          </tr>
                    <?php } } ?>
                  </tbody>
...
// delete functionality
    ...
    $(document).on('click','button[id=del_bt]',function(){
       ...
       //  alert(del_id);
              $.ajax({
                  url : '<?php echo base_url(); ?>/main_profile/delete',
                  method: 'POST',
                  data:{vv: del_id},
                  success:function(data){
                    //alert(data);
