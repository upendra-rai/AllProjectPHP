<!doctype html> <html class="fixed"> <head> <?php
$this->load->view('common/header_link'); ?> <link rel="stylesheet" href="<?php
echo base_url(); ?>/catalogs/assets/modal/modal.css"> <link rel="stylesheet"
href="<?php echo base_url();
?>/catalogs/assets/modal/notifications/Lobibox.min.css"> <link
rel="stylesheet" href="<?php echo base_url();
?>/catalogs/assets/modal/notifications/notifications.css"> <link
rel="stylesheet" href="<?php echo base_url();
?>/catalogs/assets/vendor/custom-scrollbar/jquery.mCustomScrollbar.css">
</head> <body> <section class="body"> <!-- success message --> <div
class="success_message">Kot Genrated Successfully</div> <!-- success message
                 ...
                 <header class="panel-heading" style="padding:0px 15px;">
                      ...
                      <div class="heading_box" style=" border-bottom: none; padding: 6px 2px; height:36px; background-color:#27293d;">
                          ...
                          <h2 class="panel-title" style="color:#dbd6d6; font-size:16px; line-height:10px; text-transform:uppercase;">
                            ...
                            Supplier List <i class="ion-chevron-right" style="padding:0px 10px; color:#0088cc;"></i> <?php  if(isset($product_list[0]->product_sub_category_name)){ echo $product_list[0]->product_sub_category_name;  } ?>
                            ...
                            <a href="<?php echo base_url(); ?>/customer/add_supplier"type="btn" class="btn-transparent btn-green" style="position:absolute; right:12px; top:8px;">Add Supplier</a>
                          </h2>
                      </div>
                </header>
                  ...
                  <tbody>
                      ...
                      <?php  $i = 1; if(isset($customer_details)) {foreach($customer_details as $row) {?>
                          <tr>
                              ...
                              <td><?php echo $row->supplier_mobile_no; ?></td>
                              <td><?php echo $row->supplier_email_id; ?></td>
                              <td><?php echo $row->supplier_address; ?></td>
                    <td>
                    <a 
                     href="<?php echo base_url(); ?>/customer/edit_supplier/<?php echo $row->supplier_id; ?>"> <button type="button"   style=" width:100%;"><i class="fa fa-pencil"></i>
                   </a>
                      </td>
                      

                              <td style="text-align:center;"><button type="button" class="btn btn-primary" id="confirm_del_action" data-confirm_del_id="<?php echo $row->supplier_id; ?>" style="color:#ff4747; "><i class="fa  fa-times-circle"></i></button>
                              </td>
                          </tr>
                    <?php } } ?>
                  </tbody>
...
// delete functionality
    ...
    $(document).on('click','button[id=del_bt]',function(){
       ...
       //  alert(del_id);
              $.ajax({
                  url : '<?php echo base_url(); ?>/customer/delete_supplier',
                  method: 'POST',
                  data:{vdelv: del_id},
                  success:function(data){
                    //alert(data);
