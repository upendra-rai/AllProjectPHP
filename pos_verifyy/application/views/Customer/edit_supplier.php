						 ...
						 <div class="panel-body" style="padding-left:0px; padding-right:0px;  background-color:#27293d; padding-top:15px; padding-bottom:0px;">
									  ...
									  <div class="col-md-6">
										<div class="form-group">
											<div class="col-md-12">
												<input type="text" class="form-control" name="supplier_name" value="<?php echo $selected_list[0]->supplier_name; ?>"  required><span class="placeholder">Supplier Name</span>
											</div>
										</div>
								      </div> 
								      ...
								      <div class="col-md-6">
										<div class="form-group">
											<div class="col-md-12">
												<input type="text" class="form-control" name="supplier_mobile_no" value="<?php echo $selected_list[0]->supplier_mobile_no; ?>"  required><span class="placeholder">Mobile Number</span>
											</div>
										</div>
								      </div> 
                                      ...
                                      <div class="col-md-6">
										<div class="form-group">
											<div class="col-md-12">
												<input type="text"  class="form-control" name="supplier_email_id" value="<?php echo $selected_list[0]->supplier_email_id;  ?>"  required><span class="placeholder">Email</span>
											</div>
										</div>
								      </div>
								      ...
								      <div class="col-md-6">
										<div class="form-group">
											<div class="col-md-12">
												<input type="text"  class="form-control" name="supplier_address" value="<?php echo $selected_list[0]->supplier_address; ?>"  required><span class="placeholder">Address</span>
											</div>
										</div>
								      </div>        
