					...
					<section class="section_card">
						  <div class="panel-head" style="width:100%; height:30px; background-color:transparent; color:#dbd6d6; padding:10px 16px; ">
						      <h4 style="padding:0px; margin:0px; font-size:16px; text-transform:uppercase;">
										<i class="ion-android-radio-button-on" style="margin-right:10px;"></i> Edit Holiday
									</h4>
						 </div>
						 <div class="panel-body" style="padding-left:0px; padding-right:0px;  background-color:#27293d; padding-top:15px; padding-bottom:0px;">
									  ...
									  <div class="col-md-6">
										<div class="form-group">
											<div class="col-md-12">	
												<select class="form-control" name="user_id" <?php  if(!empty($holidays_list1)){ echo 'required'; }  ?>   >
													  <option value="">Employee Name</option>
													 <?php foreach($holidays_list1 as $row){ ?>
								      ...
								      <div class="col-md-6">
										<div class="form-group">
											<div class="col-md-12">
												<input type="date" class="form-control" name="from_date" value="<?php echo $selected_list[0]->from_date; ?>"  required><span class="placeholder">from Date</span>
											</div>
										</div>
								      </div> 
                                      ...
                                      <div class="col-md-6">
										<div class="form-group">
											<div class="col-md-12">
												<input type="date"  class="form-control" name="to_date" value="<?php echo $selected_list[0]->to_date; ?>"  required><span class="placeholder">To Date</span>
											</div>
										</div>
								      </div>
