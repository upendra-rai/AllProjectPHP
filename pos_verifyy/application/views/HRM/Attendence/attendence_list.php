            ...
            <section class="section_card" id="table_section">
                 ...
                 <header class="panel-heading" style="padding:0px 15px;">
                      ...
                      <div class="heading_box" style=" border-bottom: none; padding: 6px 2px; height:36px; background-color:#27293d;">
                          ...
                          <h2 class="panel-title" style="color:#dbd6d6; font-size:16px; line-height:10px; text-transform:uppercase;">
                            ...
                            Attendence List <i class="ion-chevron-right" style="padding:0px 10px; color:#0088cc;"></i> <?php  if(isset($product_list[0]->product_sub_category_name)){ echo $product_list[0]->product_sub_category_name;  } ?>
                            ...
                            <a href="<?php echo base_url(); ?>/department/add_attendence"type="btn" class="btn-transparent btn-green" style="position:absolute; right:12px; top:8px;">Add Attendence</a>
                          </h2>
                      </div>
                </header>
                <div class="panel-body " style="padding-top:0px;">
                  ...
                  <tbody>
                      ...
                      <?php  $i = 1; if(isset($attendence_details)) {foreach($attendence_details as $row) {?>
                          <tr>
                    ...
                    <td>
                    <a 
                     href="<?php echo base_url(); ?>/department/edit_attendence/<?php echo $row->attendence_id; ?>"> <button type="button"   style=" width:100%;"><i class="fa fa-pencil"></i>
                   </a>
                      </td>
                      

                              <td style="text-align:center;"><button type="button" class="btn btn-primary" id="confirm_del_action" data-confirm_del_id="<?php echo $row->attendence_id; ?>" style="color:#ff4747; "><i class="fa  fa-times-circle"></i></button>
                              </td>
                          </tr>
                    <?php } } ?>
                  </tbody>
...
// delete functionality
    ...
    $(document).on('click','button[id=del_bt]',function(){
       ...
       //  alert(del_id);
              $.ajax({
                  url : '<?php echo base_url(); ?>/department/delete_attendence',
                  method: 'POST',
                  data:{vdelv: del_id},
                  success:function(data){
                    //alert(data);
