						 ...
						 <div class="panel-body" style="padding-left:0px; padding-right:0px;  background-color:#27293d; padding-top:15px; padding-bottom:0px;">
									  ...
									  <div class="col-md-6">
										<div class="form-group">
											<div class="col-md-12">
												<input type="text" class="form-control" name="payment_type_name" value="<?php echo $selected_list[0]->payment_type_name; ?>"  required><span class="placeholder">Payment Method</span>
											</div>
										</div>
								      </div> 
