						...
						<section class="section_card" id="table_section">
								 <header class="panel-heading" style="padding:0px 15px;">
								     	<div class="heading_box" style=" border-bottom: none; padding: 6px 2px; height:36px; background-color:#27293d;">
									        <h2 class="panel-title" style="color:#dbd6d6; font-size:16px; line-height:10px; text-transform:uppercase;">
														...
														Brand List <i class="ion-chevron-right" style="padding:0px 10px; color:#0088cc;"></i> <?php  if(isset($product_list[0]->product_sub_category_name)){ echo $product_list[0]->product_sub_category_name;  } ?>
														...
														<a href="<?php echo base_url(); ?>/brand/add_brand"type="btn" class="btn-transparent btn-green" style="position:absolute; right:12px; top:8px;">Add Brand</a>
													</h2>
									    </div>
								</header>
                          ...
                          <tr>
														  <td><?php echo $i++; ?></td>
														  	...
														  	<td><img src="<?php echo base_url(); ?>uploads/brand_image/<?php echo $row->image; ?>" style="width: 100px" ></td>
														 ...
														 <td>
                    <a 
                     href="<?php echo base_url(); ?>/brand/edit_brand/<?php echo $row->id; ?>"> <button type="button"   style=" width:100%;"><i class="fa fa-pencil"></i>
                   </a>
                      </td>
