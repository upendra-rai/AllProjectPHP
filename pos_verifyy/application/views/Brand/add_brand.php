						 ...
						 <div class="panel-body" style="padding-left:0px; padding-right:0px;  background-color:#27293d; padding-top:15px; padding-bottom:0px;">
									...
									<div class="col-md-6">
										<div class="form-group">
											<div class="col-md-12">
												<input type="text" class="form-control" name="title" value="<?php if(isset($brand_selected[0])){ echo $brand_selected[0]->title; } ?>"  required><span class="placeholder">Brand Name</span>
											</div>
										</div>
								     </div>
									 ...
									 <div class="col-md-6">
										<div class="form-group">
											<div class="col-md-12">
												<input type="text"  class="form-control" name="is_active" value="<?php if(isset($brand_selected[0])){ echo $brand_selected[0]->is_active; } ?>"  required><span class="placeholder">Product </span>
											</div>
										</div>
								      </div>
                                   ...
                                   <div class="col-md-2">          
									 <div class="col-md-12">
										  <div class="form-group">
											   <div class="col-md-12">
												 <input type="file" name="file" id="file" accept="image/*" value="" data-img_folder_name="brand_image" style="display:none;"/>
												 <label for="file" id="img_label" style="width:150px; height:150px; border:1px solid #424351; text-align:center;  font-size:25px;"><?php if(isset($product_selected[0])){ ?> <img src="<?php echo base_url(); ?>uploads/brand_image/<?php echo $brand_selected[0]->image; ?>" data-img_name="" alt="" style="width:100% ; height:100%;"/><input type="hidden" name="image_name" value="<?php echo $brand_selected[0]->image; ?>" /><button type="button" class="btn" id="temprory_remove_image" style="position:absolute; background-color:#ff4747; color:#ffffff; margin-top:-2px;">X</button>  <?php }else{ ?> <i class="fa fa-globe" style="margin-top:60px; margin-right:5px;"></i><span style="font-size:12px; ">Browse</span> <?php  } ?>  </label>
											   </div>
												 <!-- last uploaded image name -->
											   <input type="hidden" name="last_uploaded_image_name" value="<?php if(isset($brand_selected[0])){ echo $brand_selected[0]->image; }?>">
										 </div>
									</div>
                                       </div>
                                       <div class="col-md-12">
