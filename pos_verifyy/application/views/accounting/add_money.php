				...
				<section role="main" class="content-body" >
					...
					<section class="section_card">
						 ...
						 <div class="panel-body" style="padding-left:0px; padding-right:0px;  background-color:#27293d; padding-top:15px; padding-bottom:0px;">
										<form class="form-horizontal form-bordered" action="<?php echo base_url(); ?>/account/add_money/" method="POST">
                                        <div class="col-md-12">
								      ...
								      <div class="col-md-6">
										<div class="form-group">
											<div class="col-md-12">
												<input type="text" class="form-control" name="reference_no" value=""  required><span class="placeholder">Reference No</span>
											</div>
										</div>
								      </div> 
                                      ...
                                      <div class="col-md-6">
										<div class="form-group">
											<div class="col-md-12">
												<input type="number"  class="form-control" name="from_account_id" value=""  required><span class="placeholder">From Account</span>
											</div>
										</div>
								      </div>
								      ...
								      <div class="col-md-6">
										<div class="form-group">
											<div class="col-md-12">
												<input type="number"  class="form-control" name="to_account_id" value=""  required><span class="placeholder">To Account</span>
											</div>
										</div>
								      </div> 
                                      ...
                                      <div class="col-md-6">
											 <div class="form-group">
												 <div class="col-md-12">
                                                     <textarea class="form-control" name="amount"  style="height:37px;"></textarea><span class="placeholder">Amount</span>
												</div>
											</div>
						             </div>
