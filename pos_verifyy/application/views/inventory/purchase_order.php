						 ...
						 <div class="panel-body" style="padding-left:0px; padding-right:0px;  background-color:#27293d; padding-top:15px; padding-bottom:0px;">
										...
										<div class="col-md-3">
											<div class="form-group">
												<div class="col-md-12">
													  <select class="form-control" name="outlet" <?php if($this->session->userdata('outlet_id')){ echo 'disabled'; } ?> required  >
                                                     <option value=""></option>
                                                     <?php foreach($outlet_list as $row){ ?>
                                                       <option value="<?php echo $row->outlet_id ?>" <?php if($this->session->userdata('outlet_id')){ if($this->session->userdata('outlet_id') == $row->outlet_id){ echo 'selected'; }}else{ if(isset($selected_outlet)){if($selected_outlet == $row->outlet_id){ echo 'selected'; }} } ?>  ><?php echo $row->outlet_name;  ?></option>
                                                     <?php } ?>
                                                    </select><span class="placeholder">Outlet</span>
												</div>
											</div>
						               </div>
									   <div class="col-md-3"  >
										 <div class="form-group">
											 <div class="col-md-12">
												 <select class="form-control" name="supplier" required>
                                                     ...
                                                     <?php } ?>
                                                 </select><span class="placeholder">Supplier</span>
											 </div>
										 </div>
									  </div>
                                      ...
                                      <div class="col-md-3">
										<div class="form-group">
											<div class="col-md-12">
												<input type="text" class="form-control" name="discount" value=""  required><span class="placeholder">Discount</span>
											</div>
										</div>
								      </div>  
                                      ...
                                      <div class="col-md-2" style="display:none;" >
										<div class="form-group">
											<div class="col-md-12">
												<input type="text" class="form-control" name="item_details" value="" ><span class="placeholder"></span>
											</div>
										</div>
								      </div>           
                                      ...
                                      <div class="col-md-3">
											 <div class="form-group">
												 <div class="col-md-12">
                                                     <textarea class="form-control" name="discription"  style="height:37px;"><?php if(isset($product_selected[0])){ echo $product_selected[0]->discription; } ?></textarea><span class="placeholder">Note</span>
												</div>
											</div>
						             </div>         
                                </div>
...
$(document).ready(function(){
    ...
    $(document).on('change','select[name=outlet]',function(){
        
        var outlet = $(this).val();
        
        window.location.href = '<?php echo base_url(); ?>/inventory/purchase_order/'+outlet;
    });
