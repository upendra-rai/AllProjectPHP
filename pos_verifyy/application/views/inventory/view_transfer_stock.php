    		...
    		<div class="row">
    			...
    			<div class="col-xs-6 text-right">
        			...
        			<strong>Purchase Order:</strong><br>
    					Transfer ID : <?php if(isset($list[0]->transfer_id)){ echo $list[0]->transfer_id; } ?><br>
    					 <?php if(isset($list[0]->created_at)){ echo date('d-M-Y',strtotime($list[0]->created_at)); } ?><br>
    					 Status:  <?php if(isset($list[0]->status)){ if($list[0]->status == 0){ echo 'Pending'; }else if($list[0]->status == 1){ echo 'Received'; }  } ?>
    				</address>
    			</div>
    		</div>
    		<div class="row">
    			<div class="col-xs-4">
    				<address>
    					<strong>From Outlet:</strong><br>
    					<?php if(isset($list[0]->from_outlet_name)){ echo $list[0]->from_outlet_name; } ?><br> Add:
                       <?php if(isset($list[0]->from_outlet_address)){ echo $list[0]->from_outlet_address; } ?><br> Contact:
    			...
    			<div class="col-xs-6 text-left">
    				<address>
    					...
    					<?php if(isset($list[0]->to_branch_name)){ echo $list[0]->to_branch_name; } ?><br> Add:
                       <?php if(isset($list[0]->to_branch_address)){ echo $list[0]->to_branch_address; } ?>
    				</address>
    			</div>
    		</div>
    	</div>
