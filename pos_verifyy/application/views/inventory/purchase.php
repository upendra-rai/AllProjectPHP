                                        ...
                                        <div class="col-md-3">
											<div class="form-group">
												<div class="col-md-12">
                                                    ...
                                                    <input type="text" class="form-control" name="purchase_order_number" value="<?php if(isset($purchase_order_id)){ echo $purchase_order_id; } ?>"  required><span class="placeholder">PO Number</span>
												</div>
											</div>
						                </div>    
										...
										<div class="col-md-3">
											<div class="form-group">
												<div class="col-md-12">
                                                     ...
                                                     <select class="form-control" name="outlet" readonly  required>
									 ...
									 <div class="col-md-3"  >
										 <div class="form-group">
											 <div class="col-md-12">
                                                 ...
                                                 <select class="form-control" name="supplier"  readonly required>
                                                     <option value="" <?php if(isset($purchase_product_list[0])){echo 'disabled'; } ?> ></option>
                                                     <?php foreach($supplier_list as $row){ ?>
                                                       <option value="<?php echo $row->supplier_id ?>" <?php if(isset($purchase_product_list[0]->supplier_id)){ if($purchase_product_list[0]->supplier_id == $row->supplier_id){ echo 'selected'; }else{ echo 'disabled'; }  } ?> ><?php echo $row->supplier_name;  ?></option>
                                                     <?php } ?>
                                 ...
                                 <div class="col-md-3">
                                     ...
                                     <div class="col-md-3"  >
                                      ...
                                      <div class="col-md-3"  >
										 <div class="form-group">
											 <div class="col-md-12">
												 <input type="text" class="form-control" name="discount" value="<?php if(isset($purchase_product_list[0]->order_discount)){ echo $purchase_product_list[0]->order_discount;  } ?>" required><span class="placeholder">Discount</span>
											 </div>
										 </div>
									</div>  
