                       ...
                       <a href=""> <tr>
                         ...
                         <td><?php echo $i++; ?></td>
                          ...
                          <td><?php echo date('d-M-Y', strtotime($row->purchase_order_date)); ?></td>
                            <td><?php echo date('h:i:sa', strtotime($row->purchase_order_date)); ?></td>
                          ...
                          <td><?php echo  $row->item_qty; ?></td> 
                           ...
                           <td><a href="<?php echo base_url(); ?>/inventory/purchase/<?php echo $row->purchase_order_id; ?>">Purchase</a></td>  
                           
                           <td><button type="button" class="btn btn-primary" name="view_invoice" data-src="<?php echo base_url(); ?>/inventory/purchase_order_invoice/<?php echo $row->purchase_order_id; ?>"><i class="fa fa-print"></i> </button></td>
                         </tr>
                      </a>
            <?php }} ?>
               </tbody>
...
<script type="text/javascript">
     ...
     // set scroll position
            ...
            $(document).on('click','button[name=view_invoice]',function(){ 
