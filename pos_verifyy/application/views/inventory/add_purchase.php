						 ...
						 <div class="panel-body" style="padding-left:0px; padding-right:0px;  background-color:#27293d; padding-top:15px; padding-bottom:0px;">
										...
										<div class="col-md-3">
											<div class="form-group">
												<div class="col-md-12">
													<input type="text" class="form-control" name="outlet" value="" placeholder="Outlet*" required>
												</div>
											</div>
						          </div>Outlet
									 <div class="col-md-3"  >
										 <div class="form-group">
											 <div class="col-md-12">
												 <input type="text" class="form-control" name="supplier" value="" placeholder="Supplier*" required>
											 </div>
										 </div>
									</div>
									<div class="col-md-3">
										<div class="form-group">
											<div class="col-md-12">
												<input type="text" class="form-control" name="outlet" value="" placeholder="purchase Status*" required>
											</div>
										</div>
								 </div>
                                 <div class="col-md-3">
										<div class="form-group">
											<div class="col-md-12">
												<input type="text" class="form-control" name="outlet" value="" placeholder="Attach File*" required>
											</div>
										</div>
								 </div>  
                                 <div class="col-md-3">
										<div class="form-group">
											<div class="col-md-12">
												<input type="text" class="form-control" name="outlet" value="" placeholder="SELECT Product*" required>
											</div>
										</div>
								 </div>            
								 ...
								 <div class="col-md-3">
                                   ...
                                   <div class="col-md-2">
                                    ...
                                    <div class="col-md-12">
											 <div class="form-group">
												 <div class="col-md-12">
                                                     <textarea class="form-control" name="discription" placeholder="Discription"><?php if(isset($product_selected[0])){ echo $product_selected[0]->discription; } ?></textarea>
												</div>
											</div>
						             </div>         
                                </div>
