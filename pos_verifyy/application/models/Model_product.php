...
class model_product extends CI_Model {
  ...
  public function add_product($posted_category_id,$posted_subcategory_id,$product_name,$unit,$unit_price,$status,$img_name,$gst,$short_discription,$discription,$mrp_price){
	...
	public function edit_product($id,$posted_category_id,$posted_subcategory_id,$product_name,$unit,$unit_price,$status,$img_name,$count_scroll_position,$gst,$short_discription,$discription,$mrp_price)
	{
		$arr = array(
			'product_category_id' => $posted_category_id,
			'product_sub_category_id' => $posted_subcategory_id,
 ...
 // List product section
    ...
    public function select_all_product($posted_category_id,$posted_subcategory_id,$product_name){
    ...
    public function upload_product($data){
         $filedata = array(
             "product_category_id" => $data[0],
            "product_sub_category_id" => $data[1],
             "product_name" => $data[2],
            "short_discription" =>$data[3],
             "discription" =>$data[4],
             "product_unit" =>$data[5],
             "purchase_unit" =>$data[6],
             "unit_qty" =>$data[7],
             "mrp_rate" =>$data[8],
             "product_unit_price" =>$data[9],
             "purchasing_price" =>$data[10],
             "tax_id" =>$data[11],
             "tax_method" =>$data[12],
             "sgst" =>$data[13],
             "cgst" =>$data[14],
             "product_img" =>$data[15],
             "product_status" =>$data[16],
             "stock_qty" =>$data[17],
             //"stock_alert_qty" =>$data[18],
             
        
         );
        $this->db->insert("product_details",$filedata);
