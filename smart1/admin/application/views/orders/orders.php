                      ...
                      <?php $i = 1; if(isset($orders_list)){ foreach($orders_list as $row){ ?>
                        ...
                        <?php } ?>    
                         ...
                         <td class="status_td">
                           ...
                           <?php if($row->order_status == 'placed'){?> <p class="status" style="background-color:#e29739; width:80px; text-align:center; color:#ffffff; font-weight:700; border-radius:30px;">Placed</p> <?php } ?>
                        ...
                        <?php if($row->order_status == 'delivered'){?> <p class="status" style="background-color:#019727; width:80px; text-align:center; color:#ffffff; font-weight:700; border-radius:30px;">Delivered</p> <?php } ?>     
                           <?php if($row->order_status == 'canceled'){?> <p class="status" style="background-color:#ff4748; width:80px; text-align:center; color:#ffffff; font-weight:700; border-radius:30px;">Canceled</p> <?php } ?>
