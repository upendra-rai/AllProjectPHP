...
class portfolio extends CI_Controller {
	...
	public function portfolio_list(){
		...
		$data['list']=$this->portfolio_model->selectwork();
	...
	public function add_portfolio(){
		...
		if($this->input->post('submit')){
            ...
            $this->portfolio_model->add_work($image_name);
    ...
    public function edit_portfolio(){
        ...
        if($this->input->post('submit')){
                 ...
                 $this->portfolio_model->edit_work($image_name,$edit_id);
        	 ...
        	 echo $edit_id;
        	   ...
        	   $data['selected_list'] = $this->portfolio_model->selected_work($edit_id);
	...
	public function delete_portfolio(){
		...
		$this->portfolio_model->delete_data($sr_no);
