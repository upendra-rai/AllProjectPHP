									...
									<div class="panel-body">
										<form class="form-horizontal form-bordered" method="post" action="">
                                             ...
                                             <div class="form-group" style="display: none;">
												...
												<div class="col-md-6">
													<input type="file" name="file" class="form-control" id="file"  data-img_folder_name="portfolio">
												</div>
											</div>
											<label  for="file">
											<div id="img_label" style="width:150px; height:150px;">

                                                   <img src="<?php echo base_url(); ?>/upload/portfolio/<?php echo $selected_list[0]->work_image; ?>" alt="" style="width:100%; height:100%;">

                                                   <input type="hidden" value="<?php echo $selected_list[0]->work_image; ?>" name="image_name">
											</div>
										   </label>
